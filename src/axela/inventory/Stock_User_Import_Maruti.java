...
public class Stock_User_Import_Maruti extends Connect {
				...
				for (j = 1; j < rowLength + 1; j++) {
					...
					for (h = 0; h < columnLength; h++) {
						if (h == 1) {
							...
							if (comp_id.equals("1009")) { // DD Motors
								if (vehstock_branch_id.equals("1") || vehstock_branch_id.equals("2") ||
										...
										vehstock_branch_id.equals("21")) {
									vehstock_vehstocklocation_id = "1"; // PDI
								} else if (vehstock_branch_id.equals("5") || vehstock_branch_id.equals("20")) {
						...
						if (h == 2) {
							...
							if (item_code.equals("")) {
								errormsg += "Item Code should not be empty!<br>";
							}
						}
