...
public class Configure_Inventory extends Connect {
			...
			if (!comp_id.equals("0")) {
				...
				if ("Update".equals(updateB)) {
					...
					if (msg.equals("")) {
						...
						response.sendRedirect(response.encodeRedirectURL("configure-inventory.jsp?&msg=Configuration details updated successfully for Inventories!"));
					}
				}
			}
