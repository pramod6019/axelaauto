...
public class Stock_User_Import_Suzuki extends Connect {
				...
				for (j = 1; j < rowLength + 1; j++) {
					...
					for (h = 0; h < columnLength; h++) {
						...
						if (h == 1) {
							...
							if (comp_id.equals("1011")) { // Indel Hyundai
								...
								else if (branch_id.equals("78")) {
									vehstock_branch_id = "78";
									vehstock_vehstocklocation_id = "47";
								}
							}
						...
						if (h == 2) {
							...
							vehstock_item_id = CNumeric(ExecuteQuery(StrSql));
					...
					if (errormsg.equals("") && !vehstock_chassis_no.equals("")
						...
						if (!vehstock_id.equals("0")) {
							...
							SOP("vehstock_chassis_no=1=" + vehstock_chassis_no);
							SOP("vehstock_item_id=1=" + vehstock_item_id);
							SOP("vehstock_branch_id==1" + vehstock_branch_id);
							SOP("vehstock_vehstocklocation_id=1=" + vehstock_vehstocklocation_id);
