...
public class Report_JobCard_ControlBoard extends Connect {
    ...
    public String[] technicianexe_ids, advisorexe_ids, model_ids, bay_ids;
    public String technicianexe_id = "0", advisorexe_id = "0", model_id = "0", bay_id = "0";
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            if (go.equals("Go")) {
                ...
                if (!bay_id.equals("")) {
                    StrSearch += " AND baytrans_bay_id IN (" + bay_id + ")";
                }
    ...
    protected void GetValues(HttpServletRequest request,
        ...
        bay_id = RetrunSelectArrVal(request, "dr_bay");
        bay_ids = request.getParameterValues("dr_bay");
    ...
    public String ListJobCards() {
        try {
            ...
            StrSql = "SELECT jc_id, COALESCE(veh_reg_no, '') AS veh_reg_no, COALESCE(veh_id, 0) AS veh_id,"
                    ...
                    + " COALESCE(veh_chassis_no, '') AS veh_chassis_no, jc_time_in, jc_time_out, jc_time_promised, jc_time_ready,"
                    ...
                    + " LEFT JOIN " + compdb(comp_id) + "axela_service_jc_bay ON bay_id = jc_bay_id"
            ...
            if (crs.isBeforeFirst()) {
                ...
                while (crs.next()) {
                    count++;
                    Str.append("<tr valign=\"top\" bgcolor=\"").append(crs.getString("jcstage_colour")).append("\">\n");
                    Str.append("<td align=\"center\">").append(count);
                    Str.append("</td>\n<td align=\"left\">");
                    ...
                    Str.append("&nbsp;</td>\n<td align=\"center\">").append(crs.getString("veh_chassis_no"));
                    ...
                    Str.append("</td>\n<td id=\"").append(crs.getString("jc_id")).append("\" align=\"left\" class=\"manhours\">").append(crs.getString("tech_empname"));
                    Str.append("</td>\n<td id=\"").append(crs.getString("jc_id")).append("\" align=\"center\" class=\"manhours\">").append(crs.getString("bay_name"));
                    Str.append("</td>\n<td id=\"").append(crs.getString("jc_id")).append("\" align=\"center\" class=\"manhours\">");
                    ...
                    Str.append("&nbsp;</td>\n<td align=\"center\">");
                    if (Long.parseLong(crs.getString("jc_time_promised")) < Long.parseLong(ToLongDate(kknow())) && crs.getString("jc_time_ready").equals("")) {
                        Str.append("<div class=\"blink\"><b>").append(strToLongDate(crs.getString("jc_time_promised"))).append("</b></div>");
                    } else if (!crs.getString("jc_time_ready").equals("") && Long.parseLong(crs.getString("jc_time_promised")) < Long.parseLong(crs.getString("jc_time_ready"))) {
                        Str.append("<font color=\"red\"><b>").append(strToLongDate(crs.getString("jc_time_promised"))).append("</b></font>");
                    } else {
