...
public class Ticket_List_Followup extends Connect {
			...
			if (!comp_id.equals("0")) {
				...
				if (!smart.equals("yes")) {
					...
					if (msg.equals("")) {
						...
						StrHTML = FollowupSummary(request);
					}
				}
			}
		} catch (Exception ex) {
	...
	public String FollowupSummary(HttpServletRequest request) {
		...
		try {
			...
			if (crs.isBeforeFirst()) {
				Str.append("<div class=\"portlet box  \"><div class=\"portlet-title\" style=\"text-align: center\">"
						+ "<div class=\"caption\" style=\"float: none\">Ticket Follow-up Summary</div></div>"
