...
public class Contact_Check extends Connect {
	...
	public String exe_id, contact_name, contact_mobile = "", contact_id = "";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (!comp_id.equals("0")) {
			...
			if (executive_sendsms.equals("yes")) {
				...
				StrHTML = new Executive_Send_Sms().PopulateconFigDetails(request, comp_id, exe_id, contact_id, contact_name, contact_mobile);
			}
		}
	}
		...
		try {
			...
			if (crs.isBeforeFirst()) {
				...
				while (crs.next()) {
					...
					Str.append("<td valign=top align=left nowrap>");
					Str.append("<a href=\"../portal/executives-update.jsp?update=yes&emp_id=").append(crs.getString("emp_id")).append("\">Update Executive</a><br>");
					Str.append("<a href=\"../service/executive-send-sms.jsp?contact_id=0&exe_id=").append(crs.getString("emp_id"))
							.append("\" data-target=\"#Hintclicktocall\" data-toggle=\"modal\" style=\"margin-top: 1px;\"")
							.append("\">Send SMS</a></td>\n");
					// Str.append("<br><a href=\"../sales/enquiry-list.jsp?enquiry_customer_id=" + crs.getString("customer_id")).append("\">List Enquiry</a>");
					// Str.append("<br><a href=\"../service/ticket-add.jsp?add=yes&contact_id=").append(crs.getString("contact_id")).append(" \">Add Ticket</a>"
					// + "<br><a href=\"../service/ticket-list.jsp?ticket_customer_id=" + crs.getString("customer_id") + "\">List Tickets</a>"
					Str.append("</tr>\n");
