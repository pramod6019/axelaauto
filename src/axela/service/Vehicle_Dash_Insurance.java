...
public class Vehicle_Dash_Insurance extends Connect {
	...
	public String ListInsurance(String comp_id, String id) {
		...
		StrSql = "SELECT insurpolicy_id, insurpolicy_branch_id, veh_id, veh_reg_no, insurpolicy_contact_id,"
				...
				+ " preownedmodel_name, insurpolicy_active, variant_name, insurpolicy_premium_amt, insurpolicy_idv_amt,"
		...
		try {
			if (crs.isBeforeFirst()) {
				...
				while (crs.next()) {
					...
					Str.append("<a href=../insurance/insurance-update.jsp?update=yes&insurpolicy_id=").append(crs.getString("insurpolicy_id")).append("\"> Update Insurance</a>");
