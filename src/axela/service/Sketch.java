...
public class Sketch extends Connect {
...
//            if (pos != -1) {
//                fileName1 = "jcimg_" + img_id + fileName.substring(pos);
//            }
            fileName1 = savePath + "jcimg_" + img_id + ".jpg";
//            SOP("fileName1---" + fileName1);
            ...
            LinkHeader = "<a href=../service/home.jsp>Home</a> &gt; <a href=../service/index.jsp>Service</a> &gt; <a href=../service/jobcard.jsp>Job Card</a> &gt; <a href=../service/jobcard-list.jsp?all=yes>List Job Cards</a> &gt; <a href=../service/jobcard-list.jsp?jc_id=" + jc_id + ">" + name + "</a> &gt; <a href=../service/jobcard-dash-image.jsp?jc_id=" + jc_id + ">List Images</a> &gt; <a href=../service/sketch.jsp?" + QueryString + ">Canvas</a>:";
            if (add.equals("yes")) {
                status = "Add";
                displayform = "yes";
...
//                                        SOP("uploadedFile--- " + uploadedFile);
                                        if (uploadedFile.exists()) {
                                            uploadedFile.delete();
                                        }
                                        item.write(uploadedFile);
                                        response.sendRedirect(response.encodeRedirectURL("../service/jobcard-dash-image.jsp?jc_id=" + jc_id + "&msg=" + msg + ""));
