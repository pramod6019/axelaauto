...
public class Managebranchclass extends Connect {

	public String LinkHeader = "<li><a href=../portal/home.jsp>Home</a> &gt; </li><li><a href=manager.jsp>Business Manager</a> &gt; </li><li><a href=managebranchclass.jsp?all=yes>List Branch Classes</a>:</li>";
	public String LinkListPage = "managebranchclass.jsp";
	public String LinkExportPage = "";
	public String LinkFilterPage = "";
	public String LinkAddPage = "<a href=managebranchclass-update.jsp?add=yes>Add Branch Class...</a>";
		...
		try {
			...
			if (!comp_id.equals("0")) {
				...
				if (msg.toLowerCase().contains("delete")) {
					...
					msg = msg + "<br>Results for All Branches Classes!";
					StrSearch = StrSearch + " and rateclass_id > 0";
				}

				if (!(rateclass_id.equals("0"))) {
					msg = msg + "<br>Results for Branch Class ID = "
							+ rateclass_id + "!";
	...
	public String Listdata() {
		...
		if (TotalRecords != 0) {
			...
			RecCountDisplay = "Displaying " + (StartRec) + " - " + (EndRec)
					+ " of " + TotalRecords + " Branch Class(es)";
			if (QueryString.contains("PageCurrent") == true) {
				QueryString = QueryString.replaceAll("&PageCurrent="
						+ PageCurrent + "", "");
			}
			PageURL = "managebranchclass.jsp?" + QueryString + "&PageCurrent=";
			...
			try {
				...
				while (crs.next()) {
					...
					Str.append("</td>\n");
					Str.append(
							"<td><a href=\"managebranchclass-update.jsp?update=yes&rateclass_id=")
							.append(crs.getString("rateclass_id"))
							.append(" \">Update Branch Class</a></td>\n");
				}
				crs.close();
				Str.append("</tr>\n");
				Str.append("</table>\n");
