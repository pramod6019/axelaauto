...
public class Configure_Activity extends Connect {
        ...
        try {
            ...
            if ("Update".equals(updateB)) {
                ...
                if (msg.equals("")) {
                    ...
                    response.sendRedirect(response.encodeRedirectURL("configure-activity.jsp?&msg=Configuration details updated successfully for Activities!"));
                }
            }
            }
        } catch (Exception ex) {
