...
public class Executive_List extends Connect {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			if (!comp_id.equals("0")) {
				...
				// Date d = new Date();
				// d.getTime();
				// LinkHeader = "<a href=\"../portal/home.jsp\">Home</a> &gt; <a href=executives.jsp>Executive</a> &gt; <a href=\"../portal/executive-list.jsp?target=" +
	...
	public String Listdata() {
		...
		if (!msg.equals("")) {
			...
			if (TotalRecords != 0) {
				...
				PageURL = "executive-list.jsp?" + QueryString + "&PageCurrent=";
				...
				try {
					...
					while (crs.next()) {
						...
						Str.append("<td align=\"center\" valign=\"top\"><a target=_blank href=../portal/executives-dash.jsp?exe_id=").append(crs.getString("emp_id"))
						...
						if (emp_idsession.equals("1")) {
							Str.append("<br><a href=executive-update-password.jsp?redirect=1&emp_id=").append(crs.getString("emp_id"));
