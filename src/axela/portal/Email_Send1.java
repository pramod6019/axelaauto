...
public class Email_Send1 extends Connect {

	public String email_from = "", email_customer = "", email_contact = "";
	...
	public void Format() {
		...
		try {
			...
			if (!contact_id.equals("0")) {
				StrSql = StrSql + " where contact_active = '1' and contact_id =  and contact_email1 != '' " + contact_id + BranchAccess;
			} else {
