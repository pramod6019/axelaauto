...
public class Canned extends Connect {
	...
	public String enquiry_id = "", preowned_id = "", veh_id = "", jc_id = "", home = "", customer_email_to = "", customer_mobile_no = "";
			...
			if (crs.next()) {
				...
				if (home.equals("yes")) {
					Str.append("<div class=\"col-md-6 col-md-offset-3\">"
							...
							+ "name=\"txt_mobile\" type=\"text\" id=\"txt_mobile\" value=\"91-\"></input></div><br></br>");
				}
				while (crs.next()) {
					Str.append("<div>"
							+ "<button class=\"btn btn-success\" onclick='SendSMS(this.value);'"
