...
public class Faqexecutive_List extends Connect {
	// ///// List page links
	...
	public String LinkListPage = "../portal/faqexecutive-list.jsp";
	public String LinkExportPage = "";
	public String LinkFilterPage = "";
	public String LinkAddPage = "<a href=../portal/faqexecutive-update.jsp?Add=yes>Add New FAQ...</a>";
		...
		if (TotalRecords != 0) {
			...
			try {
				...
				while (crs.next()) {
					...
					Str.append("<td valign=top align=center ><a href=\"faqexecutive-list.jsp?Up=yes&faq_id=").append(crs.getString("faq_id")).append("&dr_faq_cat_id=").append(faq_cat_id)
							.append("\">Up</a> - <a href=\"faqexecutive-list.jsp?Down=yes&faq_id=").append(crs.getString("faq_id")).append("&faq_cat_id=").append(faq_cat_id)
							.append(" \">Down</a></td>\n");
					Str.append("<td valign=top align=left > " + "<a href=\"faqexecutive-update.jsp?Update=yes&faq_id=").append(crs.getString("faq_id"))
							.append(" \"> Update FAQ </a>" + "<br><a href=\"faqexecutive-doc-list.jsp?faq_id=").append(crs.getString("faq_id")).append(" \">List Documents</a>"
									+ " </td>\n");
