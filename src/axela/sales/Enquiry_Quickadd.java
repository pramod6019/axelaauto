...
public class Enquiry_Quickadd extends Connect {
	...
	public String enquiry_priorityenquiry_id = "3"; // By Default Priority should be Cold.
	...
	public String enquiry_tradein_preownedsoe_id = "0";
	public String enquiry_tradein_preownedsob_id = "0";
	public String enquiry_tradein_preownedcampaign_id = "0";
	public String soe_crm_enable = "";
	public String soe_active = "";
	// Inbound module fields
	public String inbound_check = "";
	public String enquiry_call_id = "0";
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			if (!comp_id.equals("0")) {
				...
				enquiry_call_id = CNumeric(PadQuotes(request.getParameter("enquiry_call_id")));
	...
	protected void CheckForm() throws SQLException {
		...
		if (enquiry_contact_id.equals("0")) {
			...
			if (contact_fname.equals("")) {
				msg = msg + "Enter the Contact Person First Name!<br>";
			} else {
			...
			if (contact_city_id.equals("")) {
				msg = msg + "Select Contact City!<br>";
			}
			...
			if (!IsValidMobileNo11(contact_mobile1)) {
				...
				if (crs.next()) {
					...
					if (contact_mobile1.equals(crs.getString("emp_mobile1"))) {
						msg = msg + emp_name + "'s Mobile No. can't be used!" + "<br>";
					}
				...
				if (!ExecuteQuery(StrSql).equals("")) {
					msg = msg + "Similar Mobile 1 Found!<br>";
				}
			}
		}
		if (!contact_mobile2.equals("")) {
			if (!IsValidMobileNo11(contact_mobile2)) {
				msg = msg + "Enter Valid Contact Mobile 2!<br>";
			}
			else {
				StrSql = "SELECT emp_mobile1, emp_mobile2, emp_name"
						+ " FROM " + compdb(comp_id) + "axela_emp"
				...
				StrSql = "SELECT contact_id "
						...
						+ " AND enquiry_branch_id = " + enquiry_branch_id;
				if (!ExecuteQuery(StrSql).equals("")) {
					msg = msg + "Similar Mobile 2 Found!<br>";
				}
			}
		}
			...
			if (!IsValidEmail(contact_email1)) {
				...
				if (crs.next()) {
					...
					if (contact_email1.equals(crs.getString("emp_email1"))) {
						msg = msg + emp_name + "'s Email can't be used!" + "<br>";
					}
				...
				StrSql = "SELECT contact_id "
						...
						+ " AND enquiry_branch_id = " + enquiry_branch_id;
				if (!ExecuteQuery(StrSql).equals("")) {
					msg = msg + "Similar Email 1 Found!!<br>";
				}
		...
		if (!contact_email2.equals("")) {
			if (!IsValidEmail(contact_email2)) {
				msg = msg + "Enter valid Contact Email 2!<br>";
			}
			else {
				StrSql = "SELECT emp_email1, emp_email2, emp_name"
						+ " FROM " + compdb(comp_id) + "axela_emp"
				...
				StrSql = "SELECT contact_id "
						...
						+ " AND enquiry_branch_id = " + enquiry_branch_id;
				if (!ExecuteQuery(StrSql).equals("")) {
					msg = msg + "Similar Email 2 Found!!<br>";
				}
			...
			if (!IsValidPhoneNo11(contact_phone1)) {
				...
				if (crs.next()) {
					...
					if (contact_phone1.equals(crs.getString("emp_phone1"))) {
						msg = msg + emp_name + "'s Phone No. can't be used!" + "<br>";
					}
				...
				StrSql = "SELECT contact_id "
						...
						+ " AND enquiry_branch_id = " + enquiry_branch_id;
				if (!ExecuteQuery(StrSql).equals("")) {
					msg = msg + "Similar Phone 1 Found!<br>";
				}
			}
		}
		if (!contact_phone2.equals("")) {
			if (!IsValidPhoneNo11(contact_phone2)) {
				msg = msg + "Enter Valid Contact Phone 2!<br>";
			}
			else {
				StrSql = "SELECT emp_phone1, emp_phone2, emp_name"
						+ " FROM " + compdb(comp_id) + "axela_emp"
				...
				StrSql = "SELECT contact_id "
						...
						+ " AND enquiry_branch_id = " + enquiry_branch_id;
				if (!ExecuteQuery(StrSql).equals("")) {
					msg = msg + "Similar Phone 2 Found!<br>";
				}
			}
		}
		...
		if (emp_enquiry_edit.equals("1")) {
			if (enquiry_date.equals("")) {
				...
				if (Long.parseLong(ToLongDate(kknow())) < Long.parseLong(ConvertShortDateToStr(enquiry_date))) {
					msg = msg + "Enquiry Date can't be greater than Current Date!<br>";
				}
			}
		}

		if (!comp_id.equals("1024")) {
			if (enquiry_close_date.equals("")) {
				msg = msg + "Enter Closed Date!<br>";
			} else {
				if (isValidDateFormatShort(enquiry_close_date)) {
					close_date = ConvertShortDateToStr(enquiry_close_date);
					if (Long.parseLong(ConvertShortDateToStr(enquiry_close_date)) < Long.parseLong(ConvertShortDateToStr(enquiry_date))) {
						msg = msg + " Close Date cannot be less than Enquiry Date!<br>";
					}
				} else {
					msg = msg + "Enter valid Closed Date!<br>";
				}
			}
		}

		if (enquiry_enquirytype_id.equals("0")) {
			msg = msg + "Select Type!<br>";
		}
		...
		if (enquiry_buyertype_id.equals("0") && !branch_brand_id.equals("1")) {
			msg = msg + "Select Type of Buyer!<br>";
		}
		if (enquiry_enquirycat_id.equals("0") && (branch_brand_id.equals("55"))) {
			msg = msg + "Select Category!<br>";
		}
		if (enquiry_team_id.equals("0")) {
			msg = msg + "Select Team!<br>";
		}

		if (enquiry_emp_id.equals("0")) {
			msg = msg + "Select Sales Consultant!<br>";
		}
		if (config_sales_soe.equals("1")) {
			if (enquiry_soe_id.equals("0")) {
				msg = msg + "Select Source of Enquiry!<br>";
			}
		}
		if (config_sales_sob.equals("1")) {
			if (enquiry_sob_id.equals("0")) {
				msg = msg + "Select Source of Bussiness!<br>";
			}
		}
		if (config_sales_campaign.equals("1")) {
			if (enquiry_campaign_id.equals("0")) {
				msg = msg + "Select Campaign!<br/>";
			}
		}
		// for preowned to be added by default for DDmotors
		if (comp_id.equals("1009") && enquiry_soe_id.equals("1")) {
			enquiry_tradein_preownedvariant_id = "2192";
			enquiry_tradein_preownedsoe_id = "1";
			enquiry_tradein_preownedsob_id = "1";
			enquiry_tradein_preownedcampaign_id = "2";
		}
		if (!enquiry_team_id.equals("0") && !enquiry_tradein_preownedvariant_id.equals("0")) {
			...
			if (team_preownedbranch_id.equals("0")) {
				msg = msg + "Pre-Owned Branch is not configured for this Team!<br>";
			}
			if (team_preownedemp_id.equals("0")) {
				msg = msg + "Pre-Owned Consultant is not configured for this Team!<br>";
			}
			crs.close();
		...
		if (msg.equals("")) {
			...
			try {
				...
				if (enquiry_customer_id.equals("0")
						|| (!enquiry_customer_id.equals("0") && config_customer_dupnames.equals("1"))) {
					AddCustomerFields();
				}
				if (enquiry_contact_id.equals("0")) {
					AddContactFields();
				...
				if (branch_brand_id.equals("60")) {
					enquiry_jlr_enquirystatus = "Open";
					enquiry_jlr_employmentstatus = "Other";
					enquiry_jlr_industry = "Other";
					enquiry_jlr_gender = "";
					enquiry_jlr_occupation = "Other";
					enquiry_jlr_accounttype = "Private";
				}
				...
				if (!enquiry_customer_id.equals("0") && !enquiry_contact_id.equals("0")) {
					...
					// inbound package
					if (inbound_check.equals("yes") && !enquiry_call_id.equals("0")) {
						StrSql = StrSql + " enquiry_call_id, ";
					}
					if (branch_brand_id.equals("60")) {
						StrSql = StrSql + " enquiry_jlr_enquirystatus,"
					...
					if (!enquiry_id.equals("0")) {
						...
						if (comp_email_enable.equals("1")
							...
							if (!emp_email_formail.equals("")
									&& !branch_email1.equals("")
									&& brandconfig_enquiry_email_exe_enable.equals("1")
									&& !brandconfig_enquiry_email_exe_format.equals("")
									&& !brandconfig_enquiry_email_exe_sub.equals("")) {
								SendEmailToExecutive();
							}
						}

						if (comp_sms_enable.equals("1") && config_sms_enable.equals("1")) {
							if (brandconfig_enquiry_sms_enable.equals("1") && !brandconfig_enquiry_sms_format.equals("")) {
								if (!contact_mobile1.equals("")) {
							...
							if (brandconfig_enquiry_sms_exe_enable.equals("1") && !brandconfig_enquiry_sms_exe_format.equals("")) {
	...
	protected void SendBrochureEmail() throws SQLException {
		...
		msg = "replace(" + msg + ",'[BRANCHMOBILE1]',branch_mobile1)";
	...
	protected void SendEmailToExecutive() throws SQLException {
		...
		sub = brandconfig_enquiry_email_exe_sub;
	...
	public void AddPreOwnedEnquiry() {
		try {
			...
			preowned.preowned_soe_id = enquiry_tradein_preownedsoe_id;
			preowned.preowned_sob_id = enquiry_tradein_preownedsob_id;
			preowned.preowned_campaign_id = enquiry_tradein_preownedcampaign_id;
	...
	public String PopulateSalesExecutives(String branch_id, String team_id, String enquiry_emp_id, String active, String comp_id, HttpServletRequest request) {
		...
		try {
			...
			CachedRowSet crs = processQuery(StrSql, 0);
			Str.append("<select name=\"dr_enquiry_emp_id\" id=\"dr_enquiry_emp_id\" class=\"dropdown form-control\">");
			Str.append("<option value=0>Select</option>");
			while (crs.next()) {
