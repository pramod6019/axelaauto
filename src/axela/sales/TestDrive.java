...
public class TestDrive extends Connect {
	...
	public String ListLink = "<a href=testdrive-list.jsp?smart=yes>Click here to List Test Drive</a>";
	...
	public String TestDriveSummary(HttpServletRequest request) {
		...
		try {
			...
			if (crs.isBeforeFirst()) {
				...
				Str.append("<tr>\n");
				Str.append("<th style=\"width:50%; text-align:center\">Branch Name&nbsp;&nbsp;&nbsp;</th>\n");
				Str.append("<th style=\"width:50%; text-align:center\">Test Drive Count</th>\n");
				Str.append("</tr>\n");
				while (crs.next()) {
					// SOP(".........TestDrive_count is.......---" + crs.getInt("testdrivecount"));
	...
	// commented stuffs are required in library when export is activated.. dnt delete...
	public String PopulatePrintOption()
	{
		if (printoption.equals(""))
			printoption = "TestDriveDetails1";
		String print = "";
