...
public class Enquiry_TrackingCard extends Connect {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			if (!comp_id.equals("0")) {
				...
				EnquiryDetails(request, response, enquiry_id, BranchAccess, ExeAccess, "pdf");
			}
		} catch (Exception ex) {
			SOPError("Vipul===" + this.getClass().getName());
	...
	public void EnquiryDetails(HttpServletRequest request, HttpServletResponse response, String enquiry_id, String BranchAccess, String ExeAccess, String purpose) throws IOException,
		...
		try {
			...
			StrSql = "SELECT enquiry_id, enquiry_title, enquiry_desc, enquiry_dmsno,"
					...
					+ " COALESCE(enquiry_model_id, 0) AS enquiry_model_id,"
					+ " COALESCE(model_name, 0) AS model_name, enquiry_custtype_id, "
