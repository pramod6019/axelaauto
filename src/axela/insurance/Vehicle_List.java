...
public class Vehicle_List extends Connect {
	...
	public String LinkHeader = "<a href=\"../portal/home.jsp\">Home</a>"
			+ " &gt; <a href=\"../insurance/vehicle.jsp\">Vehicles</a>"
	...
	public String LinkAddPage = "<a href=\"../service/vehicle-update.jsp?add=yes\">Add New Vehicle...</a>";
	...
	public String ListData() {
		...
		if (!msg.equals("")) {
			try {
				...
				StrSql = "SELECT veh_id, veh_item_id, veh_insuremp_id, veh_branch_id, COALESCE(model_name, '') AS model_name,"
						+ " veh_chassis_no,"
						+ " COALESCE(IF(item_code != '', CONCAT(item_name, ' (', item_code, ')'), item_name), '') AS itemname,"
						+ " COALESCE(item_id, 0) AS item_id, veh_engine_no, veh_reg_no, veh_sale_date,"
						+ " COALESCE(customer_id, 0) AS customer_id, COALESCE(customer_name, '') AS customer_name,"
						+ " COALESCE(contact_id, 0) AS contact_id, veh_so_id, veh_iacs,"
						+ " veh_modelyear,"
				...
				if (TotalRecords != 0) {
					...
					while (crs.next()) {
						...
						Str.append("<td>");
						Str.append("<a href=\"../insurance/vehicle-dash.jsp?veh_id=").append(crs.getString("veh_id")).append("\">");
						...
						if (!crs.getString("contact_mobile1").equals("")) {
							Str.append("<br/>")
									.append("<span class='customer_info customer_" + crs.getString("veh_id") + "' style='display: none;'>" + crs.getString("contact_mobile1") + "</span> (M) ("
						...
						if (!crs.getString("contact_mobile2").equals("")) {
							Str.append("<br/>")
									.append("<span class='customer_info customer_" + crs.getString("veh_id") + "' style='display: none;'>"
						...
						if (!crs.getString("contact_mobile3").equals("")) {
							Str.append("<br/>")
									.append("<span class='customer_info customer_" + crs.getString("veh_id") + "' style='display: none;'>" + crs.getString("contact_mobile3") + "</span> (M) ("
						...
						if (!crs.getString("contact_mobile4").equals("")) {
							Str.append("<br/>")
									.append("<span class='customer_info customer_" + crs.getString("veh_id") + "' style='display: none;'>" + crs.getString("contact_mobile4") + "</span> (M) ("
						...
						if (!crs.getString("contact_mobile5").equals("")) {
							Str.append("<br/>")
									.append("<span class='customer_info customer_" + crs.getString("veh_id") + "' style='display: none;'>" + crs.getString("contact_mobile5") + "</span> (M) ("
						...
						if (!crs.getString("contact_mobile6").equals("")) {
							Str.append("<br/>")
									.append("<span class='customer_info customer_" + crs.getString("veh_id") + "' style='display: none;'>" + crs.getString("contact_mobile6") + "</span> (M) ("
						...
						if (group.equals("select_jc_veh")) {
							...
							Str.append(crs.getString("veh_item_id")).append("','").append(crs.getString("itemname")).append("','");
							...
							Str.append(crs.getString("veh_item_id")).append("','");
							Str.append("');\">Select Vehicle</a>\n");
						} else {
							Str.append("<a href=\"../insurance/insurance-update.jsp?add=yes&veh_id=").append(crs.getString("veh_id")).append("&veh_branch_id=")
									.append(crs.getString("veh_branch_id")).append("\">Add Insurance</a>");
							Str.append("<br/><a href=\"../insurance/insurance-list.jsp?veh_id=").append(crs.getString("veh_id")).append("\">List Insurance</a>");
