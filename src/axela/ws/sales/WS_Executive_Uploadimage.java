...
public class WS_Executive_Uploadimage extends Connect {
    ...
    public JSONObject UploadImage(String emp_id, String comp_id, InputStream is, FormDataContentDisposition formData) {
...
//            SOP("output===="+output);
            ...
            SOPError("Uploadimage===" + this.getClass().getName());
