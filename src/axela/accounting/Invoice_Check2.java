...
public class Invoice_Check2 extends Connect {
	...
	public String config_inventory_current_stock = "0", item_serial_id = "0";
	...
	public String SearchItems() {
		...
		try {
			...
			StrSql = "SELECT item_id, item_name, price_amt, price_disc, item_code,"
					...
					+ " price_rateclass_id, IF ( item_nonstock = 0, COALESCE (stock_current_qty, 0), '_' ) AS stock_current_qty"
