...
public class Purchase_Check extends Connect {
	...
	public String SearchItems() {
		...
		try {
			...
			if (crs.isBeforeFirst()) {
				...
				Str.append("<table id=\"searchitem\" class=\"table table-bordered table-hover table-responsive\" data-filter=\"#filter\">\n");
				Str.append("<thead>\n<tr align=center>\n");
				...
				while (crs.next()) {
					...
					// boxtype_size = CNumeric(crs.getString("boxtype_size"));
					...
					Str.append("'1',");
					Str.append("'" + crs.getString("item_uom_id") + "',");
					Str.append("'" + crs.getString("price_amt") + "',");
					Str.append("'" + crs.getString("price_disc") + "',");
					// Str.append("'" + boxtype_size + "'").append(",");
					Str.append("'" + stock_current_qty + "'").append(",");
					// Str.append("" +
					// crs.getString("stockserial_serial_no")).append(",");
					Str.append("'0',");
					...
					Str.append("'" + crs.getString("price_amt") + "',");
					Str.append("'" + crs.getString("price_disc") + "',");
					Str.append("'" + discpercent + "'").append(",");
					// Str.append("'" + boxtype_size + "'").append(",");
					Str.append("'" + stock_current_qty + "'").append(",");
					// Str.append("" +
					// crs.getString("stockserial_serial_no")).append(",");
					Str.append("'0',");
					Str.append("'add','" + crs.getString("price_rateclass_id") + "');\">").append(item_name).append("</a></td>\n");
