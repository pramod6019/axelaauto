...
public class Report_Payables extends Connect {
	...
	public String voucherclass_id = "21";
	...
	public String Listdata() {
		...
		StrSql = "SELECT voucher_id, voucher_date, voucher_no, voucherclass_id, vouchertype_id, voucher_ref_no, "
				+ " voucher_customer_id, vouchertype_prefix, vouchertype_suffix, "
				+ " vouchertype_name,  customer_name, voucher_amount, voucher_delivery_date, "
				+ "customer_name,"
		...
		try {
			...
			if (crs.isBeforeFirst()) {
				...
				Str.append("<th data-hide=\"phone, tablet\">Party's Name</th>\n");
				...
				while (crs.next()) {
					...
					Str.append("<td valign=top align=left><a href='../accounting/voucher-list.jsp?voucher_id=" + crs.getString("voucher_id") + "&voucherclass_id="
					...
					Str.append("<td align='center'>").append(strToShortDate(crs.getString("voucher_delivery_date"))).append("</td>\n");
