...
public class App_TestDrive_Print_GatePass extends Connect {
			...
			if (!emp_id.equals("0")) {
				...
				if (ReturnPerm(comp_id, "emp_testdrive_access", request).equals("1")) {
					if (branch_brand_id.equals("55")) {
						response.sendRedirect(response.encodeRedirectURL("../sales/testdrive-print-gatepass-mb.jsp?"
								+ "brand_id=" + branch_brand_id + "&testdrive_id=" + testdrive_id));
					} else if (branch_brand_id.equals("11")) {
						response.sendRedirect(response.encodeRedirectURL("../sales/testdrive-print-gatepass-skoda.jsp?"
								+ "brand_id=" + branch_brand_id + "&testdrive_id=" + testdrive_id));
					} else if (branch_brand_id.equals("56")) {
						response.sendRedirect(response.encodeRedirectURL("../sales/testdrive-print-gatepass-porsche.jsp?"
								+ "brand_id=" + branch_brand_id + "&testdrive_id=" + testdrive_id));
					} else if (branch_brand_id.equals("60")) {
						response.sendRedirect(response.encodeRedirectURL("../sales/testdrive-print-gatepass-JLR.jsp?"
								+ "brand_id=" + branch_brand_id + "&testdrive_id=" + testdrive_id));
					} else if (branch_brand_id.equals("151")) {
						response.sendRedirect(response.encodeRedirectURL("../sales/testdrive-print-gatepass-onetriumph.jsp?"
								+ "brand_id=" + branch_brand_id + "&testdrive_id=" + testdrive_id));
					} else {
						response.sendRedirect(response.encodeRedirectURL("../sales/testdrive-print-gatepass1.jsp?"
								+ "brand_id=" + branch_brand_id + "&testdrive_id=" + testdrive_id));
					}
				}
			}
