		...
		if (!msg.equals("")) {
			try {
				...
				if (TotalRecords != 0) {
					...
					Str.append("<th style=\"width:200px;\" data-hide=\"phone\">Customer</th></style>\n");
					...
					while (crs.next()) {
						...
						Str.append("<tr onmouseover='ShowCustomerInfo(" + crs.getString("contact_id") + ")' onmouseout='HideCustomerInfo(" + crs.getString("contact_id") + ");'");
						...
						// Str.append(crs.getString("contact_name")).append(active);
						...
						if (!crs.getString("contact_phone1").equals("")) {
							Str.append("<span class='customer_info customer_" + crs.getString("contact_id") + "' style='display: none;'>" + crs.getString("contact_phone1") + "</span>")
									.append(" (T)").append("<br />");
						}
						if (!crs.getString("contact_phone2").equals("")) {
							Str.append("<span class='customer_info customer_" + crs.getString("contact_id") + "' style='display: none;'>" + crs.getString("contact_phone2") + "</span>")
									.append(" (T)").append("<br>");
						}
						if (!crs.getString("contact_mobile1").equals("")) {
							Str.append("<span class='customer_info customer_" + crs.getString("contact_id") + "' style='display: none;'>" + crs.getString("contact_mobile1") + "</span>")
									.append(" (M)").append("<br>");
						}
						if (!crs.getString("contact_mobile2").equals("")) {
							Str.append("<span class='customer_info customer_" + crs.getString("contact_id") + "' style='display: none;'>" + crs.getString("contact_mobile2") + "</span>")
									.append(" (M)").append("<br>");
						}
						...
						if (group.equals("select_veh_contact")) {
							update_info += "<li role=presentation><a href=# onClick=\"javascript:window.parent.SelectContact(" + crs.getString("contact_id") + ",'"
									+ crs.getString("contact_name") + "'," + crs.getString("customer_id") + ",'"
									+ crs.getString("customer_name") + "');\">Select Vehicle Contact</a></li>";
						} else if (group.equals("select_call_contact")) {
							update_info += "<li role=presentation><a href=# onClick=\"javascript:window.parent.SelectContact("
									...
									+ crs.getString("contact_landmark") + "','"
									+ crs.getString("contact_mobile1") + "','"
									+ crs.getString("contact_mobile2") + "','hide');\">Select Call Contact</a></li>";
						} else if (group.equals("select_pickup_contact")) {
							update_info += "<li role=presentation><a href=# onClick=\"javascript:window.parent.SelectContact("
									+ crs.getString("contact_id") + ",'"
									+ crs.getString("contact_name") + "','"
									+ crs.getString("customer_id") + "','" + crs.getString("customer_name") + "','"
									+ crs.getString("contact_address") + "','" + crs.getString("contact_landmark") + "','"
									+ crs.getString("contact_mobile1") + "','" + crs.getString("contact_mobile2") + "','"
									+ "hide');\">Select Pickup Contact</a></li>";
							...
							update_info += "<li role=presentation><a href=# onClick=\"javascript:window.parent.SelectContact("
									...
									+ crs.getString("customer_id") + "','"
									+ crs.getString("customer_name") + "','"
									+ "hide');\">Select Courtesy Contact</a></li>";
						} else if (group.equals("select_insurance_contact")) {
							update_info += "<li role=presentation><a href=# onClick=\"javascript:window.parent.SelectContact("
									// Str.append(crs.getString("insurpolicy_title")).append("','");
									// Str.append(crs.getString("insur_company")).append("','");
									// Str.append(crs.getString("insur_policy_name")).append("','");
									// Str.append(crs.getString("insurpolicy_policy_no")).append("','");
									// Str.append(crs.getString("insur_amt")).append("','");
									// Str.append(crs.getString("insurpolicy_desc")).append("','");
									+ crs.getString("contact_id") + ",'"
									+ crs.getString("contact_name") + "','"
									+ crs.getString("customer_id") + "','"
									+ crs.getString("customer_name") + "','"
									+ "hide');\">Select Insurance Contact</a></li>";
						} else if (group.equals("select_quote_contact")) {
							update_info += "<li role=presentation><a href=# onClick=\"javascript:window.parent.SelectContact(" + crs.getString("contact_id")
									+ ",'" + crs.getString("contact_name") + "'," + crs.getString("customer_id") + ",'"
									+ crs.getString("customer_name") + "');\">Select Contact</a></li>";
							...
							update_info += "<li role=presentation><a href=# onClick=\"javascript:window.parent.SelectContact(" + crs.getString("contact_id") + ",'"
									+ crs.getString("contact_name") + "'," + crs.getString("customer_id") + ",'"
									+ crs.getString("customer_name") + " (" + crs.getString("customer_curr_bal") + ")','hide');\">Select Contact</a></li>";
							...
							update_info += "<li role=presentation><a href=# onClick=\"javascript:window.parent.SelectCompanyContact1(" + crs.getString("contact_id") + ", "
									+ crs.getString("contact_customer_id") + ", '" + crs.getString("customer_name") + "', '"
									+ crs.getString("contact_name")
									+ "', 'prop_contact_id', 'Contact', 'span_prop_contact_id');\">Select Contact</a></li>";
						} else {
							update_info += "<li role=presentation><a href=\"customer-contact-update.jsp?update=yes&customer_id=" + crs.getString("customer_id")
									+ "&contact_id=" + crs.getString("contact_id") + "\">Update Contact Person</a></li>";
							update_info += "<li role=presentation><a href=\"../portal/activity-update.jsp?add=yes&contact_id=" + crs.getString("contact_id") + "\">Add Activity</a></li>";
							if (autosales == 1) {
								update_info += "<li role=presentation><a href=\"../sales/enquiry-quickadd.jsp?add=yes&contact_id=" + crs.getString("contact_id") + "\">Add Enquiry</a></li>";
							}
							if (autopreowned == 1) {
								update_info += "<li role=presentation><a href=\"../preowned/preowned-quickadd.jsp?add=yes&contact_id=" + crs.getString("contact_id") + "\">Add Pre-Owned</a></li>";
							}
							update_info += "<li role=presentation><a href=\"../service/ticket-add.jsp?add=yes&contact_id=" + crs.getString("contact_id") + "\">Add Ticket</a></li>";
							if (comp_email_enable.equals("1") && config_email_enable.equals("1")) {
								update_info += "<li role=presentation><a href=../portal/email-send.jsp?contact_id=" + crs.getString("contact_id") + ">Send Email</a></li>";
							}
							if (comp_sms_enable.equals("1") && config_sms_enable.equals("1")) {
								update_info += "<li role=presentation><a href=../portal/sms-send.jsp?contact_id=" + crs.getString("contact_id") + ">Send SMS</a></li>";
							}
						}
