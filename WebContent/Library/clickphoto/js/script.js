$(document).ready(function(){
	...
	webcam.set_swf_url('../Library/clickphoto/webcam/webcam.swf');
	webcam.set_api_url(urlupload);	// The upload script
	webcam.set_quality(80);				// JPEG Photo Quality
	webcam.set_shutter_sound(true, '../Library/clickphoto/webcam/shutter.mp3');
