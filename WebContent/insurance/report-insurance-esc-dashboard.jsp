...
<jsp:useBean id="mybean" class="axela.insurance.Report_Insurance_Esc_Dashboard" scope="request"/>
...
<TR>
    <TD align="left" ><a href="../portal/home.jsp">Home</a> &gt; <a href="../portal/mis.jsp">MIS</a> &gt; <a href="report-insurance-esc-dashboard.jsp">Insurance Escalation Dashboard</a>:</TD>
  </TR>
<TR>
  <TD align="left" >&nbsp;</TD>
</TR>
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0" class="tableborder">
    <tr>
      <td><table width="100%"  border="0" cellpadding="0" cellspacing="0" class="listtable">
        <tr>
          <th align="center" colspan="3" valign="top">Insurance Escalation Dashboard</th>
          </tr>
        <tr>
          ...
          <td align="left" valign="top"><select name="dr_emp" size="10" multiple="multiple" class="selectbox" id="dr_emp" style="width:250px">
            ...
            </select></td><td align="left" valign="top"><input name="submit_button" type="submit" class="button" id="submit_button" value="Go" />
