...
<jsp:useBean id="mybean"
	class="axela.insurance.ManageInsurSource_Update" scope="request" />
<%
					...
					<div class="container-fluid">
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="../portal/manager.jsp">Business Manager</a>
								&gt;</li>
							<li><a href="manageinsursource.jsp?all=yes">List
									Insurance Source</a> &gt;</li>
							<li><a
								href="manageinsursource-update.jsp?<%=mybean.QueryString%>"><%=mybean.status%>
									Insurance Source</a><b>:</b></li>
						</ul>
								...
								<div class="tab-pane" id="">
									...
									<form name="form1" method="post" class="form-horizontal">
										<div class="form-element6 form-element-center">
											...
											</label> <input name="txt_insursource_name"
												type="txt_insursource_name" class="form-control"
												value="<%=mybean.insursource_name%>" size="50"
												maxlength="255" />
										</div>
										<%
										...
										<div class="form-element6 form-element-center">
											<div class="form-element6">
												...
												<%=mybean.unescapehtml(mybean.insursource_entry_by)%>
												<input name="entry_by" type="hidden" id="entry_by"
													value="<%=mybean.insursource_entry_by%>">
											</div>
											<div class="form-element6">
										...
										<div class="form-element6 form-element-center">
											<div class="form-element6">
												...
												<%=mybean.unescapehtml(mybean.insursource_modified_by)%>
												<input name="modified_by" type="hidden" id="modified_by"
													value="<%=mybean.insursource_modified_by%>">
										...
										<center>
											...
											<input name="addbutton" type="submit" class="btn btn-success"
												id="addbutton" value="Add Insurance Source"
