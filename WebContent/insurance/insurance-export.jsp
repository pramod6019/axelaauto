...
<jsp:useBean id="mybean" class="axela.insurance.Insurance_Export" scope="request" />
				...
				<div class="page-content-inner">
					<div class="container-fluid">
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="../insurance/insurance-export.jsp">Export</a><b>:</b></li>
						</ul>
						...
						<div class="tab-pane" id="">
							<div class="portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none">Insurance Export</div>
								</div>
