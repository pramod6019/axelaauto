...
<jsp:useBean id="mybean" class="axela.insurance.Report_Insurance_Dashboard1" scope="request"/>
...
<%@include file="../portal/header.jsp" %>
        ...
        <TR>
    <TD align="left" ><a href="../portal/home.jsp">Home</a> &gt; <a href="../portal/mis.jsp">MIS</a> &gt; <a href="../service/report-insurance-dashboard1.jsp">Insurance Follow-up Dashboard</a>:</TD>
  </TR>
            <TR>
                <TD align="center" vAlign="top"><font color="#ff0000" ><b><%=mybean.msg%></b></font><br>
                        ...
                        <tr>
                            <td align="center"><table width="100%"  border="1" cellspacing="0" cellpadding="0" class="listtable">
                              <tr align="center">
                                <th colspan="8">Insurance Follow-up Traffic</th>
                              </tr>
                              <tr align="center">
