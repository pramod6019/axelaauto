...
<jsp:useBean id="mybean" class="axela.insurance.ManageInsurComp_Update" scope="request"/>
				...
				<div class="container-fluid">
					<div class="page-content-inner">
						<ul class="page-breadcrumb breadcrumb">
							...
							<li> <a href="manageinsurcomp.jsp?all=yes">List Insurance Companies</a> &gt;</li>
							<li><a href="manageinsurcomp-update.jsp?<%=mybean.QueryString%>"><%=mybean.status%> Company</a><b>:</b></li>
						</ul>
					<center>
							...
							<div class="caption" style="float: none">
								...
								<div class="portlet-body portlet-empty">
									<div class="tab-pane" id="">
										...
										<center><font size="1">Form fields marked with a red asterisk
												<b><font color=#ff0000>*</font></b> are required.<br> </font></center>
												
											<div class="form-element6 form-element-center">
												<label> Name<font color=red>*</font>: </label>
													<input name="txt_inscomp_name" type="txt_inscomp_name"
														class="form-control" value="<%=mybean.inscomp_name%>" 
														maxlength="255" />
											</div>

											<div class="form-element6 form-element-center">
												<label>Active: </label>
													<input type="checkbox" name="chk_inscomp_active"
														id="chk_inscomp_active"
														<%=mybean.PopulateCheck(mybean.inscomp_active)%>>
											</div>
											...
											<center>
												...
												<input type="hidden" id="update_button" name="update_button"
													...
													value="Update Insurance Company"
													...
													value="Delete Insurance Company"></td> 
													<% } %>
											</center>
										</form>
									</div>
...
function FormFocus() { //v1.0
  document.form1.txt_inscomp_name.focus()
}
        </script>
 </body>
</html>
