...
/* Select2 Start*/
document.writeln("<script type='text/javascript' src='../Library/select2/select2.js'></script>");
document.writeln("<link href='../Library/select2/select2.css' rel='stylesheet'>");
...
$(document).ready(function() {	
	...
	$("#maincity").select2({
		...
		formatResult: function (cities) {
			return "<div class='select2-user-result'>" + cities.text + "</div>";
		}, 
		formatSelection: function (cities) {
			//var a = document.getElementById('maincity').value =cities.id ;
			return cities.text;
		},
	...
	$("#mainzone").select2({
		...
		formatResult: function (zones) {
			return "<div class='select2-user-result'>" + zones.text + "</div>";
		}, 
		formatSelection: function (zones) {
			//var a = document.getElementById('maincity').value =cities.id ;
			return zones.text;
		},
		initSelection: function(element, callback) {
