...
<jsp:useBean id="mybean" class="axela.accessories.Report_Fitment_Due" scope="request" />
			...
			<div class="page-content">
				...
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="../accessories/report-fitment-due.jsp">Accessories Fitment Due</a><b>:</b></li>
					</ul>
						...
						<div class="tab-pane" id="">
							<div class="portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none">Accessories Fitment Due</div>
								</div>
