                                              ...
                                              <div class="form-element6">
													<label >
														...
														<select name="dr_branch_id" id="dr_branch_id"
															...
															onchange="branchUpdate('preowned');">
                                      ...
                                      <div class="form-element12">	
										...
										<div class="form-element6">
                                         ...
                                         <% }%>
											...
											<input type="hidden" id="contact_id" name="contact_id" value="<%=mybean.preowned_contact_id%>"/>
										...
										<div class="form-element12">		
											<center>
												<input name="addbutton" type="button"
													...
													value="Add <%=mybean.ReturnPreOwnedName(request)%>" onclick="submitB('preownedadd', 'addenquiry');"/> 
													<input type="hidden" name="add_button" id="add_button" value="yes" />
													<input type="hidden" name="inbound" id="inbound" value="yes" />
													<input type="hidden" id="preowned_call_id" name="preowned_call_id" value="<%=mybean.preowned_call_id%>"/>
