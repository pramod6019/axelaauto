<jsp:useBean id="mybean" class="axela.accounting.SO_Update" scope="request" />
...
<body onLoad ="<%if (mybean.status.equals("Add")) {%>getVoucherno();list_cart_items();<%}%>
			 <%if (mybean.status.equals("Update")) {%>list_cart_items();<%}%> " class="page-container-bg-solid page-header-menu-fixed">
											...
											<div class="form-element6">					
												 <label> Branch<font color="#ff0000">*</font>: </label>
														...
														<% if (mybean.emp_branch_id.equals("0")) { %>
 														<br/>
														<a href="../accounting/accounting-branch.jsp?para=sales&vouchertype_id=<%=mybean.vouchertype_id%>&voucherclass_id=<%=mybean.voucherclass_id%>">(Change Branch)</a>
														<%}%>
														<%}else{ %>
														...
														<% } %>
					                                    	<%=mybean.PopulateBranch(mybean.branch_id, "", "5", "", request)%>
					                                   	</select>
														<%}%></div>
														<div class="form-element6">
											...
											<% if(!mybean.vouchertype_id.equals("27")) {%>
													...
													<div class="form-element12">
															<label>Contact<font color="#ff0000">*</font>:</label>
																<span id="dr_contact_id"> <!-- 															<select name="dr_contact_id" class="form-control" id="dr_contact_id" > -->
...
<!-- 												RIGHT SEARCH -->
												<div class="form-element5">
													...
													<div class="form-element12 form-element">
															<center>	<label id="hint_search_item">Enter your search parameter!</label></center>
													</div>
...
$(function() {
         // credit to
          $("#accountingcustomer").change( 
               function() {
                     showHint('../accounting/ledger-check.jsp?invoicedetail=yes&vouchertype_id=' +<%= mybean.vouchertype_id%>
...
$(function() {
	$("#maincity").change(function(){ showHint('../sales/enquiry-check.jsp?city=yes&city_id=' +$(this).val(), 'zone'); });
