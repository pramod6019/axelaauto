...
<jsp:useBean id="mybean" class="axela.accounting.Report_Ageing_Payables"
	scope="request" />
			...
			<div class="page-content-inner">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href=report-ageing-receivables.jsp>Ageing Payables</a>:</li>
						...
						<div class="tab-pane" id="">
							...
							<div class="portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none">Ageing Payables
									</div>
								</div>
								<div class="portlet-body portlet-empty">
									<div class="container-fluid">
										...
										<form name="form1" class="form-horizontal" method="post">
														...
														<div class="form-element3">
															<center><label>Ageing By Group: </label>
																<input id="chk_bygroup" type="checkbox"
																	name="chk_bygroup"  
																	<%=mybean.PopulateCheck(mybean.ageing_bygroup)%> /></center>
														</div>
												<div class="form-element3">
															<label>Date: </label>
