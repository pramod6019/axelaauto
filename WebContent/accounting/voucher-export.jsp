...
<jsp:useBean id="mybean" class="axela.accounting.Voucher_Export" scope="request" />
				...
				<div class="page-content-inner">
					<div class="container-fluid">
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="../accounting/voucher-export.jsp">Voucher Export</a><b>:</b></li>
						</ul>
						...
						<div class="tab-pane" id="">
							<div class="portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none">Voucher Export</div>
								</div>
								<div class="container-fluid portlet-body portlet-empty">
									<div class="tab-pane" id="">
										<!-- START PORTLET BODY -->
										<%@ include file="../accounting/export.jsp"%>
									</div>
								</div>
							</div>
						</div>
