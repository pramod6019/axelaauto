...
<jsp:useBean id="mybean" class="axela.accounting.PurchaseInvoice_User_Import_general"
	scope="request" />
<%
			...
			<div class="page-head">
				<div class="container-fluid">
					...
					<div class="page-title">
						<h1>Import General Purchase Invoices</h1>
					</div>
					<!-- END PAGE TITLE -->
				</div>
			</div>
		      ...
		      <div class="page-content-inner">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<%} %>
						<li><a href="purchaseinvoice-user-import-general.jsp">Import General Purchase Invoices</a><b>:</b></li>
					</ul>
							...
							<form class="form-horizontal" name="frmdoc" id="frmdoc"
								...
								<div class="portlet box  ">
									<div class="portlet-title" style="text-align: center">
										<div class="caption" style="float: none">Download the General Purchase Invoices template file</div>
									</div>
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											...
											<center>
												<a href="../Library/template/purchaseinvoice-import-general.xlsx"
													target="_blank"><b>Click here to download General Purchase Invoices
														template</b></a>
											</center>
											<br>
										</div>
								...
								<div class="portlet box  ">
									<div class="portlet-title" style="text-align: center">
										<div class="caption" style="float: none">Import General Purchase Invoices</div>
									</div>
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											<!-- START PORTLET BODY -->
											...
											<div class="form-group">
												...
												<div class="col-md-6 col-xs-12 col-sm-10">
													<select class="form-control" name="dr_branch"
														...
														<%=mybean.PopulateBranch(mybean.branch_id, "", mybean.branchtype, "", request)%>
													</select>
												</div>
											</div>
											<div class="form-group">
