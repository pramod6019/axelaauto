...
<jsp:useBean id="mybean" class="axela.accounting.Bill_Update2" scope="request" />
...
<body onLoad="GrandTotal();getlocationno(); <%if (mybean.status.equals("Add")) {%>getVoucherno(); <%}%>" class="page-container-bg-solid page-header-menu-fixed" >
											...
											<div class='form-body'>
												<div class='form-group'>
													...
													<div class="form-element4 form-element">
														...
														<select name="dr_paymode1" id="dr_paymode1" class="form-control" onChange="Displaypaymode(1)">
...
function chequedate(cnt){
	 $( "#txt_vouchertrans_cheque_date"+cnt ).bootstrapMaterialDatePicker({ format : 'DD/MM/YYYY',switchOnClick : true,weekStart : 0, time: false, clearButton : true  });
}
...
<script type="text/javascript">
	...
	function Displaypaymode(cnt) {
		...
		if(payment=="2" && paymode=="2") {
			...
			$( "#txt_vouchertrans_cheque_date"+cnt ).trigger('click');
		}
