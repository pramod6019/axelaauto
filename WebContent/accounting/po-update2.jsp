...
<jsp:useBean id="mybean" class="axela.accounting.PO_Update2" scope="request" />
			...
			<div class="page-content-inner">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="../accounting/voucher-list.jsp?all=yes&voucherclass_id=<%=mybean.voucherclass_id%>
							&vouchertype_id=<%=mybean.vouchertype_id%>">List <%=mybean.vouchertype_name%>
						</a> &gt;</li>
						<li><a href="../accounting/po-update2.jsp?<%=mybean.QueryString%>"><%=mybean.status%>
							...
							<center> <font color="#ff0000"><b><%=mybean.msg%></b></font> </center>
								<div class="portlet box  ">
									<div class="portlet-title" style="text-align: center">
										<div class="caption" style="float: none"><%=mybean.status%>&nbsp;<%=mybean.vouchertype_name%></div>
									</div>
												...
												<input type="hidden" name="txt_voucher_id" id="txt_voucher_id" value="<%=mybean.voucher_id%>" />
														<div class="form-element7">
															...
															<div class="form-element6">
																		<label>Branch<font color="#ff0000">*</font><b>:</b></label>
																			...
																			<br> <a href="../accounting/accounting-branch.jsp?para=purchase&branch_id= <%=mybean.branch_id%>
																			&vouchertype_id= <%=mybean.vouchertype_id%>">(Change Branch)</a>
																			<% } %>
															</div>
															<div class="form-element6">
																		...
																		<% } %>
																						...
																						<% if(mybean.vouchertype_id.equals("1")){%>
																							<input type="" name="txt_gst_type" id="txt_gst_type" value="state" />
																						<%}else{%>
																							<input type="" name="txt_gst_type" id="txt_gst_type" value="<%=mybean.gst_type %>" />
																						<%}%>
																						...
																						<input name="txt_voucher_date" type="text" class="form-control datepicker" 
																							id="txt_voucher_date" value="<%=mybean.voucherdate%>" size="12" maxlength="12" />
																		</div>
																		<% if (mybean.vouchertype_id.equals("2")) { %>
																		...
																		<% if (mybean.vouchertype_id.equals("2")) { %>
																	<div class="form-element6">
																		<label>From Location<font color="#ff0000">*</font>: </label>
																			<select name="dr_vouchertrans_from_location_id" class="form-control" id="dr_vouchertrans_from_location_id">
																					<%=mybean.PopulateFromLocation()%>
																			</select>
																	</div>
																	<% } %>
																	<div class="form-element6">
																		<label> <% if (!mybean.vouchertype_id.equals("2")) { %> Location<font color="#ff0000">*</font>:
																		<% } else if (mybean.vouchertype_id.equals("2")) { %> To Location<font color="#ff0000">*</font>: <% } %> </label>
																						<%
																							if (mybean.vouchertype_id.equals("2") || mybean.vouchertype_id.equals("1")) {
																						%>
																						...
																						%>
																						<a href="../inventory/inventory-location-list.jsp?location_id=<%=mybean.vouchertrans_location_id%>">
																						...
																						<div style='display:none;'>
																							<select name="dr_location_id" id="dr_location_id" >
																								<%=mybean.PopulateLocation(mybean.branch_id)%>
																							</select>
																						</div>
																...
																%>
																	...
																	<div class="form-element6">
																		<label>GRN ID: </label>
																		<a href="../accounting/voucher-list.jsp?voucherclass_id=20&vouchertype_id=20&voucher_id=
																		<%=mybean.voucher_grn_id%>"><%=mybean.voucher_grn_id%></a>
																	</div>
																	<%
																		}
																	%>
																	...
																	<div class="form-element12">
																					<label>Supplier<font color="#ff0000">*</font>: </label>
																						<select class="form-control select2" id="accountingsupplier" name="accountingsupplier">
																	...
																	<div> <a href="ledger-add.jsp?add=yes&vouchertype_id= <%=mybean.vouchertype_id%>&voucherclass_id=
																	<%=mybean.voucherclass_id%>&voucherclass_file= <%=mybean.voucherclass_file%>&branch_id= <%=mybean.branch_id%>&supplier=yes"> Add Ledger</a>
																	</div>
																	</div>
																	<div class="form-element12">
																		<label>Contact<font color="#ff0000">*</font>: </label>
																			<span id="dr_contact_id"> <%=mybean.PopulateContact(mybean.voucher_supplier_id)%> </span>
																	</div>
																	<%
																		}
																	%>
...
<script type="text/javascript" src="../Library/purchase2.js?ver="+<%=mybean.jsver %>"></script>
...
$('#Hintclicktocall').on('hidden.bs.modal',function(){
	...
	showHintFootable('../accounting/purchase-details2.jsp?cart_session_id='+cart_session_id+'&cart_vouchertype_id='+vouchertype_id+'&cart_voucher_id='+voucher_id+'&list_cartitems=yes&refresh=no','po_details');
	});
</script>
...
function getVoucherno(){
	...
	if(parentvoucher == ""){
		locationid = document.getElementById("dr_location_id").value;
	} else {
 ...
 function MultipleGRN() {
	  ...
	  $('#dialog-modal').dialog({          
           ...
           close: function(){      
        	 ...
        	 showHintFootable('../accounting/purchase-details2.jsp?cart_session_id='+cart_session_id+'&cart_vouchertype_id='+ cart_vouchertype_id +'&list_cartitems=yes','po_details');       
           }     
           });
