...
<jsp:useBean id="mybean"
	class="axela.customer.Report_Top_Customers_Pending" scope="request" />
<%
			...
			<div class="page-content-inner">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="report-top-customers-pending.jsp">Top
								Customers Pending</a><b>:</b></li>
					</ul>
										...
										<form method="post" name="frm1" id="frm1"
											 ...
											 <div class="form-element3">
											     <label>Branch:</label>
											       <select name="dr_branch" id="dr_branch"
														class="form-control"
														onChange="GroupCheck();PopulateTeam();">
											     ...
											     <label>Teams:</label>
											      <div id="multiteam">
														<select name="dr_team" size="10" multiple="multiple"
															class="form-control multiselect-dropdown" id="dr_team"
															onChange="GroupCheck();">
											...
											<div class="form-element3">
											     <label>Executive:</label>
											       <div id="exeHint"><%=mybean.PopulateSalesExecutives(mybean.comp_id)%></div>
											 </div>
											 <div class="form-element3">
											     <label></label>
											      <center>
