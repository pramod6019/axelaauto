...
<jsp:useBean id="mybean" class="axela.customer.Index" scope="request"/>
			...
			<div class="page-content-inner">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="index.jsp">Customers</a><b>:</b></li>
					</ul>
								...
								<div class="form-element4 form-element">
									<div class="portlet box " >
										<div class="portlet-title" style="text-align: center">
											<div class="caption" style="float: none">Recent
												Customers | Amount</div>
										</div>
										<div class="portlet-body portlet-empty">
											<div class="container-fluid">
												<!-- START PORTLET BODY -->
												<table class="table table-responsive" width="100%">
												<%=mybean.RecentCustomers()%>
												</table>
											</div>
										</div>
									</div>
