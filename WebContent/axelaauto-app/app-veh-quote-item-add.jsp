...
<jsp:useBean id="mybean" class="axela.axelaauto_app.App_Veh_Quote_Item_Add" scope="request" />
...
<body class="page-container-bg-solid page-header-menu-fixed">
	<div class="modal-header">
		<span style="font-size: 22px; float: right; cursor: pointer;"
	...
	<div class="modal-body">
		<div class="page-content-inner container-fluid">
			...
			<div class="tab-pane" id="">
				<!-- 					BODY START -->
				<form name="frmitemadd" id="frmitemadd" class="form-horizontal"
					method="post">
					...
					<div class="form-element6">
						<label>Group<font color="#ff0000">*</font>:
						</label> <select id="dr_option_group_id" name="dr_option_group_id"
							class="form-control">
	...
	<script type="text/javascript">
		function Itemdetails(name) {
			...
			var url = "../axelaauto-app/app-veh-quote-item-add-check.jsp?itemdetails=yes";
			var param = "&group_id=" + group_id + "&item_name=" + name
					+ "&itemmaster_id=" + <%=mybean.itemmaster_id%> ;
			showHint(url + param, 'Itemdetails');
		}

		function AddItem(item_id, item_code, aftertax, item_name, option_id,
				group_name) {
			var group_id = document.getElementById("dr_option_group_id").value;
			var item_qty = document.getElementById("item_qty_" + item_id).value;

			var configitems = $("#config_details_json").html();
			console.log("config_details_json=="+configitems);
			var url = '../axelaauto-app/app-veh-quote-item-add-check.jsp?itemadd=yes'
					+ '&item_id='
					+ item_id
