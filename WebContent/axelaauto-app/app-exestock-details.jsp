...
<jsp:useBean id="mybean" class="axela.axelaauto_app.App_Exestock_Details"
	scope="request" />
<%
...
<link href="css/default.css" rel="stylesheet" type="text/css" id="style_color"> <script src="js/jquery.min.js" type="text/javascript"></script>
<style>
b {
	color: #8E44AD;
}
