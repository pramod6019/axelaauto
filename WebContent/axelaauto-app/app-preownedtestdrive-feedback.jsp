...
<jsp:useBean id="mybean"
	class="axela.axelaauto_app.App_PreownedTestDrive_Feedback"
	scope="request" />
<%
...
<html lang="en">
<head>
<title>Pre-Owned Test Drive Feedback | Axelaauto</title>
			...
			<div class="form-body">
				<div class="row">
					...
					<div class="form-group form-md-line-input">
						...
						<div class="col-md-9 col-xs-9">
							<label for="Vehicle" class="form-control"><%=mybean.variant_name%></label>
						</div>
					</div>
					...
					<div class="form-actions noborder">
						...
						<center>
							<button type="button" class="btn1" name="addbutton"
								id="addbutton">Update Feedback</button>
							<input name="testdrive_id" type="hidden" id="testdrive_id"
								...
								value="<%=mybean.testdrive_enquiry_id%>"> <br> <input
								type="hidden" name="update_button" id="update_button" value=""></input>
						</center>
						<br>
					</div>
				</div>
