...
<jsp:useBean id="mybean" class="axela.service.JobCard_User_Import_Harley_Davidson" scope="request"/>  
	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			...
			<div class="page-head">
				<div class="container-fluid">
					...
					<div class="page-title">
						<h1>Import Harley Davidson Job Cards</h1>
					</div>
					<!-- END PAGE TITLE -->
				</div>
			</div>
			...
			<div class="page-content">
				...
				<li><a href="jobcard-user-import-harley-davidson.jsp">Import Harley Davidson Job Cards</a><b>:</b> </li>
					</ul>
					...
					<div class="page-content-inner">
						<div class="tab-pane" id="">
							...
							<form class="form-horizontal" name="frmdoc" id="frmdoc"
								...
								<div class="portlet box">
									...
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											...
											<center>
												<a href="../Library/template/jobcard-template-harley-davidson.xlsx"
													target="_blank"><b>click here to download Job Card template Harley Davidson</b></a>
											</center>
										<!-- <center> 
											<a href="../Library/template/jobcard-template-harley-davidson-parts.xlsx" 
								...
								<div class="portlet box  ">
									<div class="portlet-title" style="text-align: center">
										<div class="caption" style="float: none">Import Harley Davidson Job Cards</div>
									</div>
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											<!-- START PORTLET BODY -->
											<div class="form-element6 form-element-center">
												...
												<%-- <div class="form-group">
														<label class="control-label col-md-4" >Format<font color="red">*</font>:</label>
