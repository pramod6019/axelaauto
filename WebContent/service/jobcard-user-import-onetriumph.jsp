...
<jsp:useBean id="mybean" class="axela.service.JobCard_User_Import_OneTriumph" scope="request"/>  
	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			...
			<div class="page-head">
				<div class="container-fluid">
					...
					<div class="page-title">
						<h1>Import OneTriumph Job Cards </h1>
					</div>
					<!-- END PAGE TITLE -->
				</div>
			</div>
			...
			<div class="page-content">
				...
				<li><a href="jobcard-user-import-onetriumph.jsp">Import OneTriumph Job Cards</a>: </li>
					</ul>
					...
					<div>
						...
						<div class="tab-pane" id="">
							...
							<form class="form-horizontal" name="frmdoc" id="frmdoc" enctype="MULTIPART/FORM-DATA" method="post"
								...
								<div class="portlet box">
									...
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											...
											<center>
												<a href="../Library/template/jobcard-template-OneTriumph.xlsx"
													target="_blank"><b>Click here to download Job Card
														template OneTriumph</b></a>
											</center>
											<!-- <center>
												<a href="../Library/template/jobcard-template-OneTriumph-parts.xlsx"
													target="_blank"><b>Click here to download Job Card
														template OneTriumph Parts Format</b></a>
											</center> -->
											<!-- <center>
												<a href="../Library/template/jobcard-template-OneTriumph-technician.xlsx"
													target="_blank"><b>Click here to download Job Card
														template OneTriumph Technician Format</b></a>
											</center> -->
											<br>
										</div>
									</div>
								...
								<div class="portlet box ">
									<div class="portlet-title" style="text-align: center">
										<div class="caption" style="float: none">Import OneTriumph Job Card</div>
									</div>
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											<!-- START PORTLET BODY -->
											...
											<%--<div class="form-group">
														...
														<div class="col-md-6 " style="top: 8px">
															<select name="dr_format_OneTriumph"
																class="form-control" id="dr_format_OneTriumph"
																visible="true">
																<%=mybean.PopulateFormatOneTriumph(mybean.comp_id, mybean.format_OneTriumph)%>
															</select>
														</div>
													</div> --%>
											<div class="form-element6 form-element-center">
