...
<jsp:useBean id="mybean" class="axela.service.Vehicle_Dash_Customer" scope="request"/>
...
<%@include file="../portal/header.jsp" %> <%@include file="../Library/vehicle-dash.jsp" %><table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td align="center" valign="top" height="300"><%=mybean.enquirydash.CustomerDetails(response, mybean.customer_id)%></td>
  </tr>
</table>
