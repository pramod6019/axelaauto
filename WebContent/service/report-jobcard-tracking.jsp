...
<jsp:useBean id="mybean" class="axela.service.Report_JobCard_Tracking" scope="request"/>
...
<TABLE width="98%" border="0" align="center" cellPadding="0" cellSpacing="0">
  <TR>
    <TD align="left" ><a href="../portal/home.jsp">Home</a> &gt; <a href="../portal/mis.jsp">MIS</a> &gt; <a href="report-jobcard-tracking.jsp">Job Card Tracking</a>:</TD>
  </TR>
  <tr>
        ...
        <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" class="tableborder">
          <tr>
            <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listtable">
                <tbody>
                  <tr align="center">
                    <th colspan="7"><b>Job Card Tracking</b></th>
                  </tr>
                  <tr valign="left">
                    <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="listtable">
                        <tr>
                          ...
                          <td align="left" valign="top"><%if(mybean.branch_id.equals("0")){%>
                            <select name="dr_branch" class="selectbox" id="dr_branch" onChange="ExeAdvisorCheck();ExeTechnicianCheck();">
                      ...
                      <td align="right" valign="top" nowrap>End Date<font color=red>*</font>:</td>
                           <td align="left" valign="top"><input name ="txt_endtime" id ="txt_endtime" type="text" class="textbox" value="<%=mybean.end_time %>" size="12" maxlength="10"/></td>
                            <td align="center" valign="top"><input name="submit_button" type="submit" class="button" id="submit_button" value="Print" />
                        ...
                        <td align="left" valign="top"><span id="technicianHint"><%=mybean.reportexe.PopulateTechnicians(mybean.dr_branch_id, mybean.technicianexe_ids, mybean.ExeAccess)%></span></td>
