...
<jsp:useBean id="mybean" class="axela.service.Report_PSFFollowup_Esc_Dashboard" scope="request"/>
...
<TR>
    <TD align="left" ><a href="../portal/home.jsp">Home</a> &gt; <a href="../portal/mis.jsp">MIS</a> &gt; <a href="report-psffollowup-esc-dashboard.jsp">PSF Follow-up Escalation Dashboard</a>:</TD>
  </TR>
<TR>
  <TD align="left" >&nbsp;</TD>
</TR>
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0" class="tableborder">
    <tr>
      <td><table width="100%"  border="0" cellpadding="0" cellspacing="0" class="listtable">
        <tr>
          <th colspan="6" align="right" valign="top">PSF Follow-up Escalation Dashboard</th>
          </tr>
           <tr> 
          ...
          <span id="exeHint"><%=mybean.PopulateServiceExecutives()%></span>
          </td>
