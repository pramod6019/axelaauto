...
<jsp:useBean id="mybean"
	class="axela.service.Report_Vehicle_Service_Booking_Status" scope="request" />
<%
			...
			<div class="page-content">
				...
				<div class="page-content-inner">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="report-vehicle-service-booking-status.jsp">Service Booking Status</a><b>:</b></li> 
					</ul>
						...
						<div class="tab-pane" id="">
							...
							<div class="portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none">Service Booking Status</div>
								</div>
									...
									<div class="tab-pane" id="">
										<form method="post" name="frm1" id="frm1" class="form-horizontal">
											...
											<div class="form-element3">
												...
												<span id="exeHint">
													<%=mybean.PopulateCRMExecutives(mybean.empcrm_id, mybean.comp_id, mybean.ExeAccess)%>
												</span>
											</div>

											<div class="form-element3">
												<label> Call Type:</label>
												<select name="dr_vehcalltype_id" class="form-control" id="dr_vehcalltype_id">
												...
												<!-- <div class="col-md-2 col-xs-12" id="emprows" style="top:8px"> -->
