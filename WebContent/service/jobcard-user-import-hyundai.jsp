...
<jsp:useBean id="mybean" class="axela.service.JobCard_User_Import_Hyundai" scope="request"/>  
	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			...
			<div class="page-head">
				<div class="container-fluid">
					...
					<div class="page-title">
						<h1>Import Hyundai Job Cards </h1>
					</div>
					<!-- END PAGE TITLE -->
				</div>
			</div>
			...
			<div class="page-content">
				...
				<li><a href="jobcard-user-import-hyundai.jsp">Import Hyundai Job Cards</a>: </li>
					</ul>
					...
					<div>
						...
						<div class="tab-pane" id="">
							...
							<form class="form-horizontal" name="frmdoc" id="frmdoc" enctype="MULTIPART/FORM-DATA" method="post"
								...
								<div class="portlet box">
									...
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											...
											<center>
												<a href="../Library/template/jobcard-template-hyundai.xlsx"
													target="_blank"><b>Click here to download Job Card
														template Hyundai</b></a>
											</center>
											<center>
												<a href="../Library/template/jobcard-template-hyundai-parts.xlsx"
													target="_blank"><b>Click here to download Job Card
														template Hyundai Parts Format</b></a>
											</center>
											<!-- <center>
												<a href="../Library/template/jobcard-template-hyundai-technician.xlsx"
													target="_blank"><b>Click here to download Job Card
														template Hyundai Technician Format</b></a>
											</center> -->
											<br>
										</div>
									</div>
								...
								<div class="portlet box ">
									<div class="portlet-title" style="text-align: center">
										<div class="caption" style="float: none">Import Hyundai Job Card</div>
									</div>
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											<!-- START PORTLET BODY -->
											...
											<div class="form-element6 form-element-center">
														<label >Format<font color="red">*</font>:</label>
															<select name="dr_format_hyundai"
																class="form-control" id="dr_format_hyundai"
																visible="true">
																<%=mybean.PopulateFormatHyundai(mybean.comp_id, mybean.format_hyundai)%>
															</select>
													</div>
											<div class="form-element6 form-element-center">
