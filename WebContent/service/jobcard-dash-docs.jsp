...
<jsp:useBean id="mybean" class="axela.service.JobCard_Dash_Docs" scope="request"/>
	...
	<%@include file="../portal/header.jsp"%> <%@include file="../Library/jobcard-dash.jsp" %><TABLE width="98%" height="300" border="0" align="center" cellPadding="0" cellSpacing="0">
                        <TBODY>
                            <tr>
                                ...
                                <td width="30%" align="right"><a href="../portal/docs-update.jsp?add=yes&jc_id=<%=mybean.jc_id%>" >Add
                                        New Document...</a><br>
                                </td>
