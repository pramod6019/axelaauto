...
<jsp:useBean id="mybean" class="axela.service.ManageJobCardStage" scope="request"/>
...
<%@include file="../portal/header.jsp" %> <%@include file="../Library/list-body.jsp" %> <%@include file="../Library/admin-footer.jsp" %></body>
</HTML>
