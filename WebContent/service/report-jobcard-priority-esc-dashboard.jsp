...
<jsp:useBean id="mybean" class="axela.service.Report_JobCard_Priority_Esc_Dashboard" scope="request"/>
...
<TR>
    <TD align="left" ><a href="../portal/home.jsp">Home</a> &gt; <a href="../portal/mis.jsp">MIS</a> &gt; <a href="report-jobcard-priority-esc-dashboard.jsp">Job Card Priority Escalation Dashboard</a>:</TD>
  </TR>
<TR>
  <TD align="left" >&nbsp;</TD>
</TR>
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0" class="tableborder">
    <tr>
      <td><table width="100%"  border="0" cellpadding="0" cellspacing="0" class="listtable">
        <tr>
          <th colspan="5" align="center" valign="top">Job Card Priority Escalation Dashboard</th>
          </tr>
        <tr>
          <td align="right" valign="top">Priority: </td>
          <td align="left" valign="top"><select name="dr_priority" size="10" multiple="multiple" class="selectbox" id="dr_priority" style="width:250px">
