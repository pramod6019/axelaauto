...
<jsp:useBean id="mybean" class="axela.service.ManageJCPSFConcern_Update"
	scope="request" />
<%
...
<body onLoad="FormFocus()" class="page-container-bg-solid page-header-menu-fixed">
			...
			<div class="page-head">
				<div class="container-fluid">
					...
					<div class="page-title">
						<h1><%=mybean.status%>&nbsp;JC PSF Concern
						</h1>
					</div>
					<!-- END PAGE TITLE -->
				</div>
				...
				<div class="page-content-inner">
					<div class="container-fluid">
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="managejcpsfconcern.jsp?all=yes">List JC PSF Concern</a> &gt;</li>
							<li><a href="managejcpsfconcern-update.jsp?<%=mybean.QueryString%>"><%=mybean.status%>&nbsp;JC PSF Concern</a><b>:</b>
							<li>
						</ul>
									...
									<div class="tab-pane" id="">
										...
										<form name="form1" method="post" class="form-horizontal">
											...
											<div class="form-element6 form-element-center">
												<label> JC PSF Concern Description<font color=red>*</font>: </label>
												<textarea name="txt_jcpsfconcern_desc" cols="70" rows="5"
												class="form-control" id="txt_jcpsfconcern_desc"><%=mybean.jcpsfconcern_desc%></textarea>
											</div>
											<div class="row"></div>
											<%
										...
										<div class="row"></div>
											<center>
												...
												id="button" value="Add JC PSF Concern"
												...
												<input name="button" type="submit" class="btn btn-success"
												id="button" value="Update JC PSF Concern"
												onclick="return SubmitFormOnce(document.form1, this);" />
												<input name="delete_button" type="submit"
												class="btn btn-success" id="delete_button"
												OnClick="return confirmdelete(this)" value="Delete JC PSF Concern" />
												<%
													}
												%>
											</center>
	...
	<script language="JavaScript" type="text/javascript">
		function FormFocus() { //v1.0
			document.form1.txt_jcpsfconcern_desc.focus()
		}
	</script>
</body>
</html>
