...
<jsp:useBean id="mybean" class="axela.service.JobCard_User_Import_Honda" scope="request"/>  
	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			...
			<div class="page-content">
				...
				<li><a href="jobcard-user-import-honda.jsp">Import Honda Job Cards</a><b>:</b> </li>
					</ul>
					...
					<div>
						...
						<div class="tab-pane" id="">
							...
							<form class="form-horizontal" name="frmdoc" id="frmdoc"
								...
								<div class="portlet box">
									...
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											...
											<center>
												<a href="../Library/template/jobcard-template-honda.xlsx"
													target="_blank"><b>click here to download Job Card
														template Honda</b></a>
											</center>
											<center>
												<a href="../Library/template/jobcard-template-honda-parts.xlsx"
													target="_blank"><b>Click here to download Job Card
														template Honda Parts Format</b></a>
											</center>
											<!-- <center>
												<a href="../Library/template/jobcard-template-honda-technician.xlsx"
													target="_blank"><b>Click here to download Job Card
														template Honda Technician Format</b></a>
											</center> -->
											<br>
										</div>
									</div>
								...
								<div class="portlet box  ">
									<div class="portlet-title" style="text-align: center">
										<div class="caption" style="float: none">Import Honda Job Cards</div>
									</div>
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											<!-- START PORTLET BODY -->
											...
											<div class="form-element6 form-element-center">
														<label >Format<font color="red">*</font>:</label>
															<select name="dr_format_honda"
																class="form-control" id="dr_format_volvo"
																visible="true">
																<%=mybean.PopulateFormatHonda(mybean.comp_id, mybean.format_Honda)%>
															</select>
													</div>
<div class="row">
											<div class="form-element6 form-element-center">
