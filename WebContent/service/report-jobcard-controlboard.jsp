...
<jsp:useBean id="mybean" class="axela.service.Report_JobCard_ControlBoard" scope="request"/>
...
<script language="JavaScript" type="text/javascript">
    ...
    function BayCheck() { //v1.0
	var branch_id=document.getElementById("dr_branch").value;
	showHint('../service/report-check.jsp?multiple=yes&status=yes&bay=yes&branch_id=' + GetReplace(branch_id),'bayHint');
    }
...
<body onload="blinkFont()" leftmargin="0" rightmargin="0" topmargin="0" bottommargin="0">
...
Unit12cvcvcv
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="listtable" >
                <tr>
                  <th colspan="12" align="center">Job Card Control Board</th>
                </tr>
                <tr>
                  <td align="right" valign="top">Branch<font color=red>*</font>:</td>
                  <td colspan="9" align="left" valign="top"><%if(mybean.branch_id.equals("0")){%>
                    <select name="dr_branch" id="dr_branch" class="selectbox" onChange="BayCheck();ExeTechnicianCheck(); ExeAdvisorCheck();">
                    ...
                    <%}%></td>
                  <td align="center" valign="top"><%if(!mybean.jc_data.equals("")){%>
                ...
                <tr>
                  ...
                  <td valign="top"><span id="bayHint"><%=mybean.reportexe.PopulateBay(mybean.dr_branch_id, mybean.bay_ids)%></span></td>
