...
<jsp:useBean id="mybean" class="axela.service.JobCard_Dash_Customer" scope="request"/>
...
<script>
 $(function() {
    $( "#txt_jc_time_out" ).datetimepicker();
  });
</script>
...
<%@include file="../portal/header.jsp" %> <%@include file="../Library/jobcard-dash.jsp" %><table width="98%"  height="300"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="300" valign="top"><%=mybean.jcdash.CustomerDetails(response, mybean.customer_id)%></td>
  </tr>
</table>
