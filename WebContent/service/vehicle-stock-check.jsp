...
<jsp:useBean id="mybean" class="axela.service.Vehicle_Stock_Check" scope="request"/>
...
<%@include file="../portal/header.jsp" %>
    ...
    <tr>
              <td align="left" valign="top"><a href="../portal/home.jsp">Home</a> &gt;  <a href="index.jsp">Service</a> &gt; <a href="../service/vehicle-movement-import.jsp">Vehicle Stock Check</a>:</td>
            </tr>
    <tr>
              <td align="right" valign="top" height="300"><table width="100%" border="0" align="center" cellpadding="1" cellspacing="0">
                  <tr>
...
<form name="frmdoc"  id="frmdoc" enctype="MULTIPART/FORM-DATA" method="post" onsubmit="aletdisp();">
                  <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0"  class="tableborder">
                      ...
                      <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="listtable">
                          <tr align="center">
                          <th height="20" colspan="3" ><strong><font color="#ffffff" >Vehicle Stock Check</font></strong></th>
                        </tr>
                          <tr>
                ...
                <tr><td><table width="100%" border="1" align="center" cellpadding="0" cellspacing="0"  class="tableborder">
                      <tr>
