...
<jsp:useBean id="mybean" class="axela.service.User_Import_Vehicle_DMS_Status" scope="request"/>  
		...
		<div class="page-content-wrapper">
			...
			<div class="page-content">
				<div class="container-fluid">
					...
					<li><a href="../service/user-import-vehicle-dmsstatus.jsp">Import Vehicle DMS Status</a><b>:</b> </li>
					</ul>
										...
										<div class="tab-pane" id="">
											...
											<div class="form-group">
												<label class="control-label col-md-4"
													style="margin-top: 10px;">DMS Status<font color=red>*</font>:
												</label>
