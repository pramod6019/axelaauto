...
<jsp:useBean id="mybean" class="axela.service.Report_JobCard_Stage_Esc_Status" scope="request"/>
...
<TR>
    <TD align="left" ><a href="../portal/home.jsp">Home</a> &gt; <a href="../portal/mis.jsp">MIS</a> &gt; <a href="report-jobcard-stage-esc-status.jsp">Job Card Stage Escalation Status</a>:</TD>
  </TR>  
  <TR>
      ...
      <form name="formemp"  method="post">
        ...
        <tr align="center">
          <td colspan="2" align="center" valign="middle"><table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" class="listtable">
            <tbody>
              <tr align="center">
                <th><b>Job Card Stage Escalation Status</b></th>
              </tr>
              <tr valign="left">
