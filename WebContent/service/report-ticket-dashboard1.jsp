...
<jsp:useBean id="mybean" class="axela.service.Report_Ticket_Dashboard1" scope="request"/>
...
<%@include file="../portal/header.jsp" %>
        ...
        <TR>
    <TD align="left" ><a href="../portal/home.jsp">Home</a> &gt; <a href="../portal/mis.jsp">MIS</a> &gt; <a href="../service/report-ticket-dashboard1.jsp">Ticket Dashboard</a>:</TD>
  </TR>
            <TR>
          ...
          <td align="center"><form method="post" name="frm1"  id="frm1">
              <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0"  class="tableborder">
                <tr>
                  <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="listtable" >
                   <tr>
                        <th colspan="4" align="center">Ticket Dashboard</th>
                      </tr>
                      <tr>
                         <td align="right" valign="top">Executive:</td>
                        <td valign="top"><%=mybean.PopulateExecutive()%></td>
            ...
            <TR>
                <TD  align="middle" vAlign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td colspan="2" align="center" valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="5" >
                                    <tr align="center" valign="top">
                                      <td width="25%" ><table width="100%"  border="1" align="center" cellpadding="0" cellspacing="0" class="listtable">
                                        <tr>
                                          <th colspan="2">Tickets for Today</th>
                                        </tr>
                                        <%=mybean.TicketsToday%>
                                      </table></td>
                                      <td width="25%"><table width="100%"  border="1" align="center" cellpadding="0" cellspacing="0" class="listtable" >
                                        <tr align="center">
                                          <th colspan="2">Closed Tickets for Today</th>
                                        </tr>
                                        <%=mybean.ClosedTicketsToday%>
                                      </table></td>
                                      <td width="25%"><table width="100%"  border="1" align="center" cellpadding="0" cellspacing="0" class="listtable" >
                                        <tr align="center">
                                          <th colspan="2">Open Status </th>
                                        </tr>
                                        <%=mybean.OpenStatus%>
                                      </table></td>
                                      <td width="25%"><table width="100%"  border="1" align="center" cellpadding="0" cellspacing="0" class="listtable" >
                                        <tr align="center">
                                          <th colspan="2">Open Departments</th>
                                        </tr>
                                        <%=mybean.OpenDepartments%>
                                      </table></td>
                                    </tr>
                          </table></td>
                        </tr>
                        ...
                        <tr>
                            <td align="center"><table width="100%"  border="1" cellspacing="0" cellpadding="0" class="listtable">
                              <tr align="center">
                                <th colspan="8">Tickets Traffic</th>
                              </tr>
                              <tr align="center">
