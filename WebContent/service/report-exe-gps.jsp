...
<jsp:useBean id="mybean" class="axela.service.Report_Exe_GPS" scope="request"/>
...
<TABLE width="98%" border="0" align="center" cellPadding="0" cellSpacing="0">
  <TR>
    <TD align="left" ><a href="../portal/home.jsp">Home</a> &gt; <a href="../portal/mis.jsp">MIS</a> &gt; <a href="../service/report-exe-gps.jsp">GPS Dashboard</a>:</TD>
  </TR>
  <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="listtable" >
                ...
                <tr>
                  ...
                  <td align="right" valign="top" nowrap>Service Advisor<font color=red>*</font>:</td>
                  <td valign="top"><span id="exeHint"><%=mybean.PopulateServiceExecutives()%></span></td>
                  <td valign="top"><input type="submit" name="submit_button" id="submit_button" class="button" value="Go"/>
