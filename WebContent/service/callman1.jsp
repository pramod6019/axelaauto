            ...
            <td align="right" valign="top"><form name="form1"  method="post">
                ...
                <tr>
                    <td align="center"><span id="span_branch" style="display:none">
                      ...
                      <input name ="txt_search" type="text" class="textbox" id="txt_search" size="25" maxlength="255" onKeyUp="CallSearch();" value="" onfocus="OnFocus(this.id);" onBlur="OnBlur(this.id);"/>
                      </span>
