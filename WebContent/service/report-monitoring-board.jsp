...
<jsp:useBean id="mybean" class="axela.service.Report_Monitoring_Board" scope="request" />
...
<body  class="page-container-bg-solid page-header-menu-fixed" onload="returnfieldscheck();" >
			...
			<div class="page-head">
				<div class="container-fluid">
					...
					<div class="page-title">
						<h1>Service Monitoring Board</h1>
					</div>
					<!-- END PAGE TITLE -->
				</div>
			</div>
			...
			<div class="page-content-inner">
				<div class="container-fluid">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="../service/report-monitoring-board.jsp">Service Monitoring Board</a><b>:</b></li>
						...
						<div class="tab-pane" id="">
							...
							<div class="portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none">Service Monitoring Board
									</div>
								</div>
								<div class="portlet-body portlet-empty container-fluid">
									<div class="tab-pane" id="">
										...
										<input id="hold" type="hidden" />
											...
											<div class="form-element3">
												<label>Job Card Warranty:</label> 
												<select name="dr_warranty" class="form-control" id="dr_warranty">
												<%=mybean.PopulateJobCardWarranty()%>
												</select>
											</div>
							...
							%>
							<!-- START PORTLET BODY -->
							<center><a id="btnExport" onclick="HtmlTableToExcel('table');" ><b>Export</b></a></center>
...
<script language="JavaScript" type="text/javascript">
	...
	function returnfieldscheck(){
		 var fieldscheck = outputSelected(document.getElementById("dr_field").options);
// 		 console.log("fieldscheck=="+fieldscheck);
		 
		 showHint('../service/mis-check1.jsp?field=yes&fieldscheck=' + fieldscheck, 'divOrderby');
	    }
