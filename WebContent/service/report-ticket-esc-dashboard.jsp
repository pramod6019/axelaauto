...
<jsp:useBean id="mybean" class="axela.service.Report_Ticket_Esc_Dashboard" scope="request"/>
...
<TR>
    <TD align="left" ><a href="../portal/home.jsp">Home</a> &gt; <a href="../portal/mis.jsp">MIS</a> &gt; <a href="report-ticket-esc-dashboard.jsp">Ticket Escalation Dashboard</a>:</TD>
  </TR>
<TR>
  <TD align="left" >&nbsp;</TD>
</TR>
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0" class="tableborder">
    <tr>
      <td><table width="100%"  border="0" cellpadding="0" cellspacing="0" class="listtable">
        <tr>
          <th colspan="5" align="right" valign="top">Ticket Escalation Dashboard</th>
          </tr>
        <tr>
          <td align="right" valign="top">Department: </td>
          <td align="left" valign="top"><select name="dr_ticket_dept" size="10" multiple="multiple" class="selectbox" id="dr_ticket_dept" style="width:250px">
