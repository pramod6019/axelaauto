...
<jsp:useBean id="mybean" class="axela.home.DDMotors_Booking_Enquiry" scope="request" />
	...
	<br/>
		<center>
				...
				<input name="txt_contact_mobile1" type="text" class="form-control txbx text-left" id="txt_contact_mobile1" onkeypress="javascript: return isNumber(event);"
					value="91-<%=mybean.contact_mobile1%>" size="32" maxlength="13" /> <div class="text-left">(91-9999999999)</div> <div class="text-left" id="mobileError"></div>
					<br/>
