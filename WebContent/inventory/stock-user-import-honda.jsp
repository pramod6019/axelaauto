...
<jsp:useBean id="mybean" class="axela.inventory.Stock_User_Import_Honda" scope="request"/>    
		...
		<div class="page-content-wrapper">
			...
			<div class="page-content-inner">
				<div class="container-fluid">
					...
					<li><a href="../inventory/stock-user-import-honda.jsp">Honda Stock Import</a>: </li>
					</ul>
								...
								<div class="portlet box  ">
									...
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											...
											<center>
											<a href="../Library/template/stock-template-honda.xlsx" 
											target="_blank"><b>Click here to download Stock Template Honda</b></a> 
											</center>
											<br>
										</div>
									</div>
