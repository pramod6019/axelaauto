...
<jsp:useBean id="mybean" class="axela.inventory.PrincipalSupport_User_Import" scope="request"/>  
			...
			<div class="page-head">
				<div class="container-fluid">
					...
					<div class="page-title">
						<h1>Import Principal Support</h1>
					</div>
					<!-- END PAGE TITLE -->
				</div>
			</div>
			...
			<div class="page-content">
				...
				<div class="page-content-inner">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="principalsupport-user-import.jsp">Import Principal Support</a>: </li>
					</ul>
							...
							<form class="form-horizontal" name="frmdoc" id="frmdoc" enctype="MULTIPART/FORM-DATA" method="post" >
								<div class="portlet box">
									<div class="portlet-title" style="text-align: center">
										<div class="caption" style="float: none">Download the Principal Support template file</div>
									</div>
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											<!-- START PORTLET BODY -->
											<center>
												Start importing Principal Support by downloading template file. <br />
												Download the template and enter Principal Support as per the
												headings. <br /> Headings marked in red are manadatory.
												Don't change the header columns.
											</center>
											<center>
											<a href="../Library/template/principalsupport-template.xlsx"
													target="_blank"><b>Click here to download Principal Support
														template </b></a>
											</center>
											<br>
										</div>
								...
								<div class="portlet box ">
									<div class="portlet-title" style="text-align: center">
										<div class="caption" style="float: none">Import Principal Support</div>
									</div>
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											<!-- START PORTLET BODY -->
											<div class="form-element6 form-element-center">
												...
												<select name="dr_brand" id="dr_brand" class="form-control" >
													<%=mybean.PopulateBrands(mybean.comp_id)%>
												</select>
											</div>
...
function FormFocus() { //v1.0
  document.frmdoc.dr_brand.focus();
}
        </script>
  </body>
</html>
