...
<jsp:useBean id="mybean" class="axela.inventory.Orderplaced_User_Import" scope="request"/>  
			...
			<div class="page-content">
				...
				<div class="page-content-inner">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="orderplaced-user-import.jsp">Import Orderplaced</a>: </li>
					</ul>
							...
							<form class="form-horizontal" name="frmdoc" id="frmdoc" enctype="MULTIPART/FORM-DATA" method="post" >
								<div class="portlet box">
									<div class="portlet-title" style="text-align: center">
										<div class="caption" style="float: none">Download the Orderplaced template file</div>
									</div>
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											<!-- START PORTLET BODY -->
											<center>
												Start importing Orderplaced by downloading template file. <br />
												Download the template and enter Orderplaced as per the
												headings. <br /> Headings marked in red are manadatory.
												Don't change the header columns.
											</center>
											<center>
											<%if(mybean.comp_id.equals("1011")){ %>
												<a href="../Library/template/orderplaced-template-indel.xlsx"
													target="_blank"><b>Click here to download Orderplaced
														template </b></a>
														<%}else{ %>
														<a href="../Library/template/orderplaced-template.xlsx"
													target="_blank"><b>Click here to download Orderplaced
														template </b></a>
														<%} %>
											</center>
								...
								<div class="portlet box ">
									<div class="portlet-title" style="text-align: center">
										<div class="caption" style="float: none">Import Orderplaced</div>
									</div>
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											<!-- START PORTLET BODY -->
