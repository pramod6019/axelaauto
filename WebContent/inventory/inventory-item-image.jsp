...
<jsp:useBean id="mybean" class="axela.inventory.Inventory_Item_Image"
	scope="page" />
<%
			...
			<div class="page-content-inner">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="inventory-item-list.jsp?all=yes"> List Items</a> &gt;</li>
						<li><a href="inventory-item-image.jsp?item_id=<%=mybean.item_id%>">Update
								Image</a><b>:</b></li>
					</ul>
					<center>
							...
							<form name="frmdoc" enctype="MULTIPART/FORM-DATA" method="post"
								...
								<div class="portlet box  ">
									<div class="portlet-title" style="text-align: center">
										<div class="caption" style="float: none">Update Image</div>
									</div>
									<div class="portlet-body portlet-empty">
										<div class="container-fluid">
											...
											%>
											<img src="../Thumbnail.do?itemimg=<%=mybean.img_value%>">
												<br> <%
 	}
 %>
											<div class="form-element6 form-element-center">
												<label >Select Image<font color=red>*</font>: </label>
											...
											<div align="center">
												<input name="update_button" type="submit"
													...
													value="Update Image" /> <input type="hidden" name="update"
													value="yes"> <input type="hidden" name="item_id"
