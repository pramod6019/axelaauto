...
<jsp:useBean id="mybean" class="axela.inventory.Item_User_Import"
	scope="request" />
<%
			...
			<div class="page-content-inner">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="item-user-import.jsp">Import Items</a><b>:</b></li>
					</ul>
					...
					<div>
						...
						<div class="tab-pane" id="">
							...
							<form class="form-horizontal" name="frmdoc" id="frmdoc"
								...
								<div class="portlet box  ">
									<div class="portlet-title" style="text-align: center">
										<div class="caption" style="float: none">Download the
											Items template file</div>
									</div>
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											<!-- START PORTLET BODY -->
											<center>
												Start importing Items by downloading template file. <br />
											...
											<center>
												<a href="../Library/template/item-import.xlsx"
													target="_blank"><b>Click here to download Items
														template</b></a>
											</center>
											<br>
										</div>
								...
								<div class="portlet box  ">
									<div class="portlet-title" style="text-align: center">
										<div class="caption" style="float: none">Import Items</div>
									</div>
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											<!-- START PORTLET BODY -->
											<div class="form-element6 form-element-center">
												...
												<div class="form-element6 form-element-center">
												<label>Effective From<font color=#ff0000><b> *</b></font>:</label>
													<input name="txt_effective_from" id="txt_effective_from"
														value="" class="form-control datepicker"
														type="text" value='<%=mybean.effectivefrom%>'  />
											</div>
											
												<div class="form-element6 form-element-center">
												<label>Item Type<font color=red>*</font>: </label>
													<select name="dr_item_type" id="dr_item_type"
														class="form-control" >
														<%=mybean.PopulateItemType(mybean.comp_id)%>
													</select>
											</div>
												<div class="form-element6 form-element-center">
												<label>Stock Location<font color=red>*</font>: </label>
													<select name="dr_stock_location" id="dr_stock_location"
														class="form-control" >
