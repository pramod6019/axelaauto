...
<jsp:useBean id="mybean"
	class="axela.inventory.Stock_User_Import_Porsche" scope="request" />
<%
			...
			<div class="page-content-inner">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="../inventory/stock-user-import-porsche.jsp">Porsche Stock Import</a><b>:</b></li>
					</ul>
					...
					<div>
						...
						<div class="tab-pane" id="">
							...
							<form class="form-horizontal" name="frmdoc" id="frmdoc"
								...
								<div class="portlet box  ">
									...
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											...
											<center>
												<a href="../Library/template/stock-template-porsche.xlsx"
													target="_blank"><b>Click here to download Stock
														Template Porsche</b></a>
											</center>
											<br>
										</div>
									</div>
								...
								<div class="portlet box  ">
									<div class="portlet-title" style="text-align: center">
										<div class="caption" style="float: none">Porsche Import Stock</div>
									</div>
									<div class="portlet-body portlet-empty">
										<div class="container-fluid">
											<!-- START PORTLET BODY -->
