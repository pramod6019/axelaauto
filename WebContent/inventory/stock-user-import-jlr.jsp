...
<jsp:useBean id="mybean" class="axela.inventory.Stock_User_Import_JLR" scope="request"/>    
			...
			<div class="page-content-inner">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="../inventory/stock-user-import-jlr.jsp">JLR Stock Import</a><b>:</b></li>
					</ul>
								...
								<div class="portlet box  ">
									...
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											...
											<center>
												<a href="../Library/template/stock-template-jlr.xlsx"
													target="_blank"><b>Click here to download Stock Template JLR</b></a>
											</center>
											<br>
										</div>
									</div>
