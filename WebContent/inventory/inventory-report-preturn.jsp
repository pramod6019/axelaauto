...
<jsp:useBean id="mybean" class="axela.inventory.Inventory_Report_PReturn" scope="request"/>
			...
			<div class="page-content-inner">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="inventory-report-preturn.jsp">Purchase Return Report</a><b>:</b></li>
					</ul>
				...
				<div class="portlet-body portlet-empty">
					<div class="container-fluid">
						...
						<form method="post" class="form-horizontal" name="frm1"  id="frm1">
											...
											<div class="form-element3">
												<label> Location<font color=red>*</font>:
												</label>
												<div id="dr_location">
											...
											<div class="form-element3">
												<label> Item Code: </label> <input name="txt_item_code"
													id="txt_item_code" type="text" class="form-control"
													value="<%=mybean.item_code%>" size="12" maxlength="10" />
											</div>
											<div class="form-element3">
												<label> Item Name: </label> <input name="txt_item_name"
													id="txt_item_name" type="text" class="form-control"
													value="<%=mybean.item_name%>" size="12" maxlength="10" />
												</td>
											</div>
											<div class="form-element3">
												<label> Supplier ID: </label> <input name="txt_supplier_id"
													id="txt_supplier_id" type="text" class="form-control"
													value="<%=mybean.supplier_id%>" size="12" maxlength="10" />
											</div>
