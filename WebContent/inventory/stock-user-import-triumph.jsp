...
<jsp:useBean id="mybean"
	class="axela.inventory.Stock_User_Import_Triumph" scope="request" />
<%
				...
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="../inventory/stock-user-import.jsp">Import
								Stock</a> &gt;</li>
						<li><a href="../inventory/stock-user-import-triumph.jsp">Triumph
								...
								<div class="portlet box  ">
									...
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											...
											<center>
												<a href="../Library/template/stock-template-triumph.xlsx"
													target="_blank"><b>Click here to download Stock
														Template Triumph</b></a>
											</center>
											<br>
										</div>
									</div>
