...
<jsp:useBean id="mybean" class="axela.inventory.Inventory_Cat_Update"
	scope="request" />
<%
			...
			<div class="page-content-inner">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="inventory-cat-list.jsp?all=yes">List
								Categories</a>&nbsp;&gt;</li>
						<li><a
							href="inventory-cat-update.jsp?<%=mybean.QueryString%>"><%=mybean.status%>&nbsp;Category</a>:<b>:</b></li>
							...
							<div class="portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none">
										<strong><font color="#ffffff">&nbsp; <%=mybean.status%>&nbsp;Category
										</font></strong>
									</div>
								</div>
									...
									<div class="container-fluid">
										...
										<form name="form1" class="form-horizontal" method="post">
											...
											<div class="form-element6 form-element-center">
													<label>Parent Category<b><font color="#ff0000">*</font></b>: </label>
														<select id="dr_cat_parent" name="dr_cat_parent"
															class="form-control">
															<option value=0>Parent Level</option>
															<%=mybean.PopulateCat(mybean.cat_parent_id, "1")%>
														</select>
											</div>
											<div class="form-element6 form-element-center">
													<label>Name<font color="#ff0000">*</font>: </label>
														<input name="txt_cat_name" type="text"
															class="form-control" id="txt_cat_name"
															value="<%=mybean.cat_name%>" size="50" maxlength="255">
												</div>
											<%
