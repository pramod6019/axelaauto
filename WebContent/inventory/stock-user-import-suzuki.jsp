...
<jsp:useBean id="mybean" class="axela.inventory.Stock_User_Import_Suzuki" scope="request"/>    
			...
			<div class="page-content-inner">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="../inventory/stock-user-import-suzuki.jsp">Suzuki Stock Import</a><b>:</b></li>
					</ul>
								...
								<div class="portlet box  ">
									...
									<div class="portlet-body portlet-empty">
										<div class="container-fluid">
											...
											<center>
												<a href="../Library/template/stock-template-suzuki.xlsx"
									...
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											...
											<div class="form-element6 form-element-center">
												...
												</label> <input NAME="filename" Type="file"
