			...
			<div class="page-content-inner">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="../inventory/report-stock-summary.jsp">Stock Summary </a><b>:</b></li>
					</ul>
						...
						<div class="tab-pane" id="">
							...
							<div class="portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none">Stock Summary</div>
								</div>
								<div class="portlet-body portlet-empty">
									<div class="container-fluid">
										<!-- START PORTLET BODY -->
										<form method="post" name="frm1" class="form-horizontal" id="frm1" onsubmit="return itemserach();">
											<div class="form-element3">
												...
												<input name="txt_search" type="text" class="form-control" id="txt_search" 
												value="" size="30" maxlength="255" onKeyUp="StockSearch();" />
											...
											<div class="form-element3">
												...
												<div id="multiprincipal">
													<select name="dr_principal"  class="form-control multiselect-dropdown" multiple="multiple" id="dr_principal"
														onChange="PopulateCategory();PopulateModels();PopulateBranches();PopulateRegion();">
											...
											<div class="form-element3">
												...
												<div id="catHint">
												 <%=mybean.mischeck.PopulateCategory(mybean.brand_id,mybean.cat_ids, mybean.comp_id, "0", "1", request)%>
												</div>
											</div>
											...
											<div class="form-element12">
												<center>
													...
													<input name="export" id="export"  type="submit" class="btn btn-success" value="Export" />
													<input type="hidden" name="submit_button" value="Submit" />
<%-- 													<input type="hidden" name="PageCurrent" value="<%=mybean.PageCurrents %>" /> --%>
												</center>
											</div>
										</form>
									</div>
...
<%-- 								<center><div><%=mybean.PageNaviStr %></div></center> --%>
...
// 			url = url+data;
		...
		function loadTable(pageNumber){
			...
			var url="report-stock-summary-check.jsp?PageNavi=yes&PageCurrent=" + pageNumber +"";
			var Hint ="tableDate";
		...
		function callAjax(starttime, endtime, search) {
			showHint( "../inventory/report-stock-summary-check.jsp?itemsearch=itemsearch&list=yes&search="
							+ search + "&txt_starttime=" + starttime + "&txt_endtime=" + endtime, "list");
		}
		...
		function PopulateCategory() { //v1.0
			var brand_id = outputSelected(document .getElementById("dr_principal").options);
			showHint('../inventory/mis-check.jsp?multiple=yes&brand_id=' + brand_id + '&cat=yes', 'catHint');
		}
