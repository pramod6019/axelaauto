...
<jsp:useBean id="mybean" class="axela.inventory.Stock_User_Import_Nexa" scope="request"/>    
				...
				<div class="page-content-inner">
					<div class="container-fluid">
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="../inventory/stock-user-import.jsp">Import Stock</a> &gt;</li>
							<li><a href="../inventory/stock-user-import-nexa.jsp">Nexa Stock Import</a>:</li>
						</ul>
						...
						<div class="tab-pane" id="">
							...
							<form class="form-horizontal" name="frmdoc" id="frmdoc"
								enctype="MULTIPART/FORM-DATA" method="post" onsubmit="aletdisp();">
								<div class="portlet box  ">
									<div class="portlet-title" style="text-align: center">
										<div class="caption" style="float: none">
											Download the Stock template file
										</div> 
									</div>
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											...
											<center>
												<a href="../Library/template/stock-template-nexa.xlsx"
...
<!-- 											</div> -->
   ...
   <script language="JavaScript" type="text/javascript">
	function PopulateLocation() {
		...
		showHint('../inventory/inventory-check.jsp?vehstock_branch_id=' + branch_id + '&brand_id=10'+ '&branch_location=yes' , 'dr_location');
	}
</script>
  </body>
</html>
