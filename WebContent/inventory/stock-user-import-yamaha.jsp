...
<jsp:useBean id="mybean"
	class="axela.inventory.Stock_User_Import_Yamaha" scope="request" />
<%
				...
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="../inventory/stock-user-import.jsp">Import
								Stock</a> &gt;</li>
						<li><a href="../inventory/stock-user-import-yamaha.jsp">Yamaha
								...
								<div class="portlet box  ">
									...
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											...
											<center>
												<a href="../Library/template/stock-template-yamaha.xlsx"
