...
(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      '<input type="text" style="margin-top: -40px;" class="form-control" autocomplete="off"' +
...
//////////////////////////////////start of components-bootstrap-select.js   ///////////////////////////////////////////
...
$('#Hintclicktocall, .modal').on('shown.bs.modal', function() {
	 FormElements();
});

//////////////////////////////////End of components-bootstrap-select.js   ///////////////////////////////////////////



$(function(){
	 $(".bootstrap-select >.btn").on('blur',function(){ $(".bs-searchbox > input").val("");}); 
});