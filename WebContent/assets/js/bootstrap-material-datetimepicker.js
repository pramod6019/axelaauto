...
//	alert(color2);
   ...
   function Plugin(element, options)
   {
      ...
      this.$element = $(element);
//$(".dtp div.dtp-time").attr( styel,background: color2);
   ...
   Plugin.prototype =
           {
              ...
              initTemplate: function ()
              {
                  ...
                  var yearHtml =
                      ...
                      '<div><a href="javascript:void(0);" class="btn btn-default dtp-select-year-range before" style="margin: 0;"><i style="font-size:22px;" class="fa fa-angle-up"></i></a></div>' +
                      yearPicker +
                      '<div><a href="javascript:void(0);" class="btn btn-default dtp-select-year-range after" style="margin: 0;"><i style="font-size:22px;" class="fa fa-angle-down"></i></a></div>' +
                      '</div>';
                 ...
                 this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                         ...
                         '<div class="dtp-actual-day">Error</div>' +
                         '<div class="dtp-close"><a href="javascript:void(0);"><i style="font-size:14px;" class="fa fa-close"></i></a></div>' +
                         '</header>' +
                         '<div class="dtp-date hidden">' +
                         '<div>' +
                         '<div class="left center p10">' +
                         '<a href="javascript:void(0);" class="dtp-select-month-before"><i style="font-size:22px;" class="fa fa-angle-left"></i></a>' +
                         '</div>' +
                         '<div class="dtp-actual-month p80">MAR</div>' +
                         '<div class="right center p10">' +
                         '<a href="javascript:void(0);" class="dtp-select-month-after"><i style="font-size:22px;" class="fa fa-angle-right"></i></a>' +
                         '</div>' +
                         ...
                         '<div>' +
                         '<div class="left center p10">' +
                         '<a href="javascript:void(0);" class="dtp-select-year-before"><i style="font-size:22px;" class="fa fa-angle-left"></i></a>' +
                         '</div>' +
                         '<div class="dtp-actual-year p80'+(this.params.year?"":" disabled")+'">2014</div>' +
                         '<div class="right center p10">' +
                         '<a href="javascript:void(0);" class="dtp-select-year-after"><i style="font-size:22px;" class="fa fa-angle-right"></i></a>' +
                         '</div>' +
                         '<div class="clearfix"></div>' +
                         '</div>' +
                         '</div>' +
                         ...
                         '<button class="dtp-btn-now btn btn-success hidden">' + this.params.nowText + '</button>' +
                         '<button class="dtp-btn-clear btn btn-success hidden">' + this.params.clearText + '</button>' +
                         '<button class="dtp-btn-cancel btn btn-success">' + this.params.cancelText + '</button>' +
              ...
              initHours: function ()
              {
                 ...
                 for (var i = 0; i < 12; i++)
                 {
                    ...
                    var fill = ((this.currentDate.format(hFormat) == i) ? color2 : 'transparent');
                 ...
                 if (!this.params.shortTime)
                 {
                    for (var i = 0; i < 12; i++)
                    {
                       ...
                       var fill = ((this.currentDate.format(hFormat) == (i + 12)) ? color2 : 'transparent');
              ...
              initMinutes: function ()
              {
                 ...
                 for (var i = 0; i < 60; i++)
                 {
                    ...
                    var color = ((this.currentDate.format("m") == i) ? color2 : 'transparent');
              ...
              createSVGClock: function (isHour)
              {
                 ...
                 if (isHour)
                 {
                    ...
                    var svgHourHand = this.createSVGElement("line", {class: 'hour-hand', x1: 0, y1: 0, x2: 0, y2: hl, stroke: color2, 'stroke-width': 8});

                    svgGElement.appendChild(svgMinuteHand);
                    svgGElement.appendChild(svgHourHand);
                 } else
                 {
                    var svgMinuteHand = this.createSVGElement("line", {class: 'minute-hand', x1: 0, y1: 0, x2: 0, y2: -150, stroke: color2, 'stroke-width': 2});
              ...
              constructHTMLCalendar: function (date, calendar)
              {
                 ...
                 for (var i = 0; i < calendar.days.length; i++)
                 {
                    ...
                    if (calendar.days[i] != 0)
                    {
                        ...
                        {
                            _template += '<span onclick="alert(clicked);" class="dtp-select-day">' + moment(calendar.days[i]).locale(this.params.lang).format("DD") + '</span>';
                        } 
                        else if(( localStorage.previous_date == 1) && (new Date().getDate() == moment(calendar.days[i]).locale(this.params.lang).format("DD")) && (new Date().getMonth() == calendar.days[10]._d.getMonth()) &&(new Date().getYear() == calendar.days[10]._d.getYear()))
                        	{
                        	_template += '<a onclick="localStorage.previous_date = 0;" class="dtp-select-day" style="background-color: #B8D0F8; border-radius: 50%;color: white;">' + moment(calendar.days[i]).locale(this.params.lang).format("DD") + '</a>';
                        	}
                        else
                        {
                            if (moment(calendar.days[i]).locale(this.params.lang).format("DD") === moment(this.currentDate).locale(this.params.lang).format("DD"))
                            {
                                _template += '<a onclick="localStorage.previous_date = 1;" class="dtp-select-day selected">' + moment(calendar.days[i]).locale(this.params.lang).format("DD") + '</a>';
                            } else
                            {
                                _template += '<a onclick="localStorage.previous_date = 1;" class="dtp-select-day">' + moment(calendar.days[i]).locale(this.params.lang).format("DD") + '</a>';
                            }
                        }
              ...
              _onSelectHour: function (e)
              {
                 if (!$(e.target).hasClass('disabled'))
                 {
                    ...
                    $(parent.find('#h-' + value)).attr('fill', color2);
              ...
              _onSelectMinute: function (e)
              {
                 if (!$(e.target).hasClass('disabled'))
                 {
                    ...
                    $(parent.find('#m-' + value)).attr('fill', color2);
