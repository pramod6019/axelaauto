...
<jsp:useBean id="mybean" class="axela.preowned.Preowned_Click_Image" scope="request"/>
...
<html>
    ...
    <script language="JavaScript" type="text/javascript">
		...
		var urlupload = 'preowned-click-upload.jsp?preowned_id='+preowned_id;
		function GetImages(){
			setTimeout(function() {
				showHint("preowned-click-browse.jsp?preowned_id=" + preowned_id, "photos");
			}, 2000);
		}
    </script>
    ...
    <body onload="showHint('preowned-click-browse.jsp?preowned_id=' + preowned_id,  'photos');" leftmargin="0" rightmargin="0" topmargin="0" bottommargin="0" border="0">
