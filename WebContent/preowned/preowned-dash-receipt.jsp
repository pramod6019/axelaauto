...
<jsp:useBean id="mybean" class="axela.preowned.Preowned_Dash_Receipt" scope="request"/>
...
<body class="page-container-bg-solid page-header-menu-fixed">
	...
	<script type="text/javascript">
		$(function() {
			$('table').footable({ toggleHTMLElement : '<span><div class="footable-toggle footable-expand" border="0"></div>'
