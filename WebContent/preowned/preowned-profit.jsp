...
<jsp:useBean id="mybean" class="axela.preowned.Preowned_Profit"
	scope="request" />
<%
...
<head>
<title><%=mybean.AppName%> - <%=mybean.GetSession("comp_name", request)%>
</title>
			...
			<div class="page-content-inner">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="../preowned/index.jsp"><%=mybean.ReturnPreOwnedName(request)%></a>
							&gt;</li>
						<li><a href="preowned-profit.jsp"><%=mybean.ReturnPreOwnedName(request)%>
								Profit</a>:</li>
					</ul>
										...
										<div class="tab-pane" id="">
											...
											<form name="form1" method="post" class="form-horizontal">
												...
												<div class="container-fluid">
													...
													<div class="form-element3">
														<div>Model:</div>
														<select class="form-control" id="modelvariant"
															name="modelvariant">
															<%=mybean.PopulateVariant(mybean.preowned_variant_id)%>
														</select>
													</div>
					...
					request)%>
													...
													<div class="form-element3">
														<div>Teams:</div>
														<span id="teamHint"> <%=mybean.mischeck.PopulatePreownedTeams(mybean.branch_id,
					mybean.team_ids, mybean.comp_id, request)%>
														</span>
													</div>
													...
													<div class="form-element3">
														...
														<div id="exeHint">
															<%=mybean.mischeck.PopulatePreownedExecutives(
					mybean.branch_id, mybean.team_id, mybean.comp_id)%>
														</div>
													</div>
												</div>
												...
												<div class="form-element12">
													<center>
														...
														<input type="hidden" name="submit_button" value="Submit">
															<a href="../sales/veh-salesorder-list.jsp?smart=yes"
															class="btn btn-success" target="_blank">Export</a>
													</center>
												</div>
