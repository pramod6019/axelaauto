...
<jsp:useBean id="mybean" class="axela.preowned.ManageExtColour_Update" scope="request" />
...
<body onLoad="FormFocus()" class="page-container-bg-solid page-header-menu-fixed">
			...
			<div class="page-head">
				<div class="container-fluid">
					...
					<div class="page-title">
						<h1><%=mybean.status%>&nbsp;Exterior Color
						</h1>
					</div>
					<!-- END PAGE TITLE -->
				</div>
				...
				<div class="container-fluid">
					<div class="page-content-inner">
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="manageextcolour.jsp?all=yes">List Exterior Colors</a> &gt;</li>
							<li><a href="manageextcolour-update.jsp?<%=mybean.QueryString%>"><%=mybean.status%>&nbsp;Exterior Color</a><b>:</b></li>
						</ul>
						...
						<div class="tab-pane" id="">
							...
							<div class="portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none"> <%=mybean.status%>&nbsp;Exterior Color </div>
								</div>
										...
										<form name="form1" method="post" class="form-horizontal">
											...
											<div class="form-element6 form-element-center">
												<label>Color<font color=red>*</font>:</label>
													<input name="txt_extcolour_name" type="text" class="form-control" id="txt_extcolour_name" 
														value="<%=mybean.extcolour_name%>" maxlength="255" />
											</div>
										...
										<div class="form-element6 form-element-center">
											...
											<div class="form-element6">
												<label>Modified Date:</label>
													...
													<input name="modified_date" type="hidden" id="modified_date" value="<%=mybean.modified_by%>">
											</div>
											...
											<center>
												...
												<input name="addbutton" type="submit"
													class="btn btn-success" id="addbutton" value="Add Colour"
													onClick="return SubmitFormOnce(document.form1, this);" />
												<input type="hidden" name="add_button" id="add_button"
													value="yes"> <%} else if (mybean.status.equals("Update")) {%>
	...
	function FormFocus() { //v1.0
		document.form1.txt_extcolour_name.focus()
	}
</script>
</body>
</html>
