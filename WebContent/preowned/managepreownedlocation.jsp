<%-- 
    Document   : manage-stock-location
    Created on : Mar 20, 2013, 2:33:33 PM
    Author     : Ajit
--%>

<%@ page errorPage="../portal/error-page.jsp" %>
<jsp:useBean id="mybean" class="axela.preowned.ManagePreownedLocation" scope="request"/>
			...
			<div class="page-head">
				<div class="container-fluid">
					...
					<div class="page-title">
						<h1>List Pre-Owned Locations</h1>
					</div>
					<!-- END PAGE TITLE -->
				</div>
			</div>
