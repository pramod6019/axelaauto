...
<jsp:useBean id="mybean" class="axela.preowned.Target" scope="request" />
<%
			...
			<div class="page-content-inner">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="target.jsp">Target</a><b>:</b></li>
					</ul>
					<!-- END PAGE BREADCRUMBS -->
						...
						<div class="tab-pane" id="">
							<form name="form1" method="get" class="form-horizontal">
								...
								<div class="portlet box">
									<div class="portlet-title" style="text-align: center">
										<div class="caption" style="float: none">Pre-Owned Target Summary</div>
									</div>
									<div class="portlet-body portlet-empty container-fluid">
										<div class="tab-pane" id="">
											<!-- START PORTLET BODY -->
