...
<jsp:useBean id="mybean" class="axela.sales.Report_Sales_Pipeline"
	scope="request" />
<%
...
<body class="page-container-bg-solid page-header-menu-fixed">
			...
			<div class="page-content">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="../sales/report-sales-pipeline.jsp">Sales Pipeline</a><b>:</b></li>
					</ul>
						...
						<div class="tab-pane" id="">
							...
							<div class="portlet box">
								...
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none">Sales Pipeline</div>
								</div>
							...
							<%
									if ((!mybean.SalesPipeline.equals(""))) {
								%>
								<div class="portlet box">
									<div class="portlet-title" style="text-align: center">
								...
								<%
									} else if ((!mybean.NoSalesPipeline.equals(""))) {
								%>
								...
								<div class="portlet box">
									...
									<div class="portlet-body portlet-empty container-fluid">
										<div class="tab-pane" id="">
											<!-- START PORTLET BODY -->
											<center><font color="red"><b><%=mybean.NoSalesPipeline%></b></font></center>
										</div>
									</div>
								</div>
	...
	<script class="code" type="text/javascript">
		   ...
		   var export1 = {
				...
				menuItemOutput:{
					fileName: "Sales Pipe Line"
				}
		   };
  
            AmCharts.ready(function () {
				
                var chartData = <%=mybean.SalesPipeline%>;
    
                // SERIAL CHART
                chart = new AmCharts.AmSerialChart();
                chart.dataProvider = chartData;
                chart.categoryField = "stage";
