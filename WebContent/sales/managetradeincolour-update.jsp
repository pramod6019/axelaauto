...
<jsp:useBean id="mybean" class="axela.sales.ManageTradeInColour_Update"
	scope="request" />
<%
...
<body onLoad="FormFocus()" class="page-container-bg-solid page-header-menu-fixed">
				...
				<div class="page-content-inner">
					<div class="container-fluid">
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="managetradeincolour.jsp?all=yes">List Colours</a> &gt;</li>
							<li><a href="managetradeincolour-update.jsp?<%=mybean.QueryString%>"><%=mybean.status%>&nbsp;Colour</a><b>:</b></li> </ul>
									...
									<div class="tab-pane" id="">
										...
										<form name="form1" method="post" class="form-horizontal">
											...
											<div class="form-element6 form-element-center">
												...
												<input name="txt_tradeincolour_name" type="text"
												class="form-control" id="txt_tradeincolour_name"
												value="<%=mybean.tradeincolour_name%>" size="50"
												maxlength="255" />
											</div>
	...
	<script language="JavaScript" type="text/javascript">
		function FormFocus() { //v1.0
			document.form1.txt_tradeincolour_name.focus()
		}
	</script>
</body>
</HTML>
