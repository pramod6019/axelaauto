...
<jsp:useBean id="mybean" class="axela.sales.Incentive_Calculate" scope="request" />
			...
			<div class="page-content-inner">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="../sales/incentive-calculate.jsp">Incentive Calculate</a><b>:</b></li> 
					</ul>
						...
						<div class="tab-pane" id="">
							...
							<div class="portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none">Incentive Calculate
									</div>
								</div>
...
<!-- 											<div class="form-element11 form-element"> -->
											<div class="form-element2">
												...
												<div>
													<select name="dr_principal" size="10" class="form-control"  id="dr_principal"
...
<script language="JavaScript" type="text/javascript">
		...
		function PopulateExecutives() { //v1.0
			...
			showHint('../sales/mis-check1.jsp?exe_branch_id=' + branch_id + '&team_id=0&executives=yes', 'exeHint');
		}
