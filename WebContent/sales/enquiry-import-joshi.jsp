...
<jsp:useBean id="mybean" class="axela.sales.Enquiry_Import_Joshi"
	scope="request" />
<%
			...
			<div class="page-content">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="enquiry-import.jsp">Import Enquiry</a><b>:</b></li>
					</ul>
					...
					<div class="page-content-inner">
						<div class="tab-pane" id="">
							...
							<form class="form-horizontal" name="frmdoc" id="frmdoc"
								...
								<div class="portlet box  ">
									...
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											...
											<center>
												<a href="../Library/template/enquiry.xlsx" target="_blank"><b>Click
								...
								<div class="portlet box  ">
									<div class="portlet-title" style="text-align: center">
										<div class="caption" style="float: none">Import Enquiry
										</div>
									</div>
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
