...
<jsp:useBean id="mybean" class="axela.sales.Report_Enquiry_Esc_Status"
	scope="request" />
<%
			...
			<div class="page-head">
				<div class="container-fluid">
					...
					<div class="page-title">
						<h1>Enquiry Escalation Status</h1>
					</div>
					<!-- END PAGE TITLE -->
				</div>
			</div>
			  ...
			  <div class="page-content-inner">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="../sales/report-enquiry-esc-status.jsp">Enquiry Escalation Status</a><b>:</b></li> 
					</ul>
