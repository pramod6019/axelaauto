...
<jsp:useBean id="mybean" class="axela.sales.Enquiry_User_Import_Maruti_Temp"
	scope="request" />
<%
			...
			<div class="page-content">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="enquiry-user-import-maruti.jsp">Import Maruti Enquiries</a><b>:</b></li>
					</ul>
					...
					<div class="page-content-inner">
						<div class="tab-pane" id="">
							...
							<form class="form-horizontal" name="frmdoc" id="frmdoc"
								...
								<div class="portlet box  ">
									...
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											...
											<center>
												<a href="../Library/template/enquiry_maruti.xlsx" target="_blank"><b>Click
								...
								<div class="portlet box  ">
									<div class="portlet-title" style="text-align: center">
										<div class="caption" style="float: none">Import Maruti Enquiries
										</div>
									</div>
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
												...
												<label>Branch<font color=red>*</font>: </label>
													<select name="enquiry_branch_id" class="form-control"
														id="enquiry_branch_id">
															<%=mybean.PopulateBranch(mybean.branch_id, "", "", mybean.branch_brand_id, request)%>
													</select>
											</div>
