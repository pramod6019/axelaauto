...
<jsp:useBean id="mybean"
	class="axela.sales.Enquiry_Followup_Trigger_Status" scope="request" />
...
<body leftmargin="0" rightmargin="0" topmargin="0" bottommargin="0">
	<table width="100%" height="157" border="0" cellpadding="1"
		cellspacing="0"><%@include file="../portal/header.jsp"%>
		<form name="form1" method="post">
			<%if(mybean.branch_id.equals("0")) {%>
			<tr align="center">
				<td colspan="2" align="center" valign="middle"><b>Enquiry
						Follow-up Escalation Status </b><br> <br></td>
			</tr>
			<tr align="center">
			...
			<tr align="center">
				<td colspan="2" align="center" valign="middle">Branch: <select
