...
<jsp:useBean id="mybean" class="axela.sales.ManageTradeInMake_Update"
	scope="request" />
<%
				...
				<div class="page-content-inner">
					<div class="container-fluid">
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="managetradeinmake.jsp?all=yes">List Make</a> &gt;</li>
							<li><a href="managetradeinmake-update.jsp?<%=mybean.QueryString%>"><%=mybean.status%>&nbsp;Make</a><b>:</b></li> </ul>
									...
									<div class="tab-pane" id="">
										...
										<form name="form1" method="post" class="form-horizontal">
											...
											<div class="form-element6 form-element-center">
												...
												<input name="txt_tradeinmake_name" type="text"
													class="form-control" id="txt_tradeinmake_name"
													value="<%=mybean.tradeinmake_name%>" size="50"
													maxlength="255" />
											</div>
											...
											<center>
												...
												<input name="button" type="submit" class="btn btn-success"
													id="button" value="Update Make"
													onClick="return SubmitFormOnce(document.form1, this);" />
												<input name="delete_button" type="submit"
													class="btn btn-success" id="delete_button"
													OnClick="return confirmdelete(this)" value="Delete Make" />
												<%
													}
												%>
											</center>
