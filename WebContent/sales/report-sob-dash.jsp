...
<jsp:useBean id="mybean" class="axela.sales.Report_SOB_Dash" scope="request"/>
				...
				<div class="page-content-inner">
					<div class="container-fluid">
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="../sales/report-sob-dash.jsp">SOB Dashboard</a><b>:</b></li> 
						</ul>
						...
						<div class="tab-pane" id="">
							...
							<div class="portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none">SOB Dashboard</div>
								</div>
											...
											<div class="form-element4">
												...
												<div id="multiprincipal">
													<select name="dr_principal" size="10" multiple="multiple" class="form-control multiselect-dropdown" id="dr_principal"
														...
														<%=mybean.mischeck.PopulatePrincipal(mybean.brand_ids, mybean.comp_id, request)%></select>
												</div>
											</div>
								...
								<div class="portlet box  ">
									<div class="portlet-title" style="text-align: center">
										<div class="caption" style="float: none">SOB Details</div>
									</div>
									<div class="portlet-body portlet-empty container-fluid">
										<div class="tab-pane" id="">
											...
											%>
											<div class="form-element12" id="chart1" style="height: 1200px;"></div>
											<center>
								...
								<div class="portlet box  ">
									<div class="portlet-title" style="text-align: center">
										<div class="caption" style="float: none">SOB Summary</div>
									</div>
								...
								<div class="portlet box  ">
									<div class="portlet-title" style="text-align: center">
										<div class="caption" style="float: none">Closed Summary
										</div>
									</div>
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
