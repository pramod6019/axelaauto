...
<jsp:useBean id="mybean" class="axela.sales.SalesOrder_Dash_Docs" scope="request"/>
...
<%@include file="../portal/header.jsp"%> <%@include file="../Library/so-dash.jsp" %><TABLE width="98%" border="0" align="center" cellPadding="0" cellSpacing="0">
  <TR>
    <TD  align="center" vAlign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <TBODY>
          <tr>
            <td width="30%" align="right"><a href="../portal/docs-update.jsp?add=yes&so_id=<%=mybean.so_id%>" >Add
