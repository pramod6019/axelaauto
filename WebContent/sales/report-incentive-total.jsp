...
<jsp:useBean id="mybean" class="axela.sales.Report_Incentive_Total" scope="request" />
			...
			<div class="page-head">
				<div class="container-fluid">
					...
					<div class="page-title">
						<h1>Sales Executives Incentive</h1>
					</div>
					<!-- END PAGE TITLE -->
				</div>
			</div>
			...
			<div class="page-content-inner">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="../sales/report-incentive-total.jsp">Sales Executives Incentive</a><b>:</b></li> 
					</ul>
						...
						<div class="tab-pane" id="">
							...
							<div class="portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none">Executives Incentive
									</div>
								</div>
