...
<jsp:useBean id="mybean" class="axela.sales.ManageFollowupDesc_Update"
	scope="request" />
<%
				...
				<div class="page-content-inner">
					<div class="container-fluid">
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="managefollowupdesc.jsp?all=yes">List Follow-up Description</a> &gt;</li>
							<li><a href="managefollowupdesc-update.jsp?<%=mybean.QueryString%>"><%=mybean.status%> Follow-up Description</a><b>:</b></li>
						</ul>
									...
									<div class="tab-pane" id="">
										...
										<form name="form1" method="post" class="form-horizontal">
											...
											<div class="form-element6 form-element-center" id="emprows">
												...
												<input name="txt_followupdesc_name" type="text"
												class="form-control" id="txt_followupdesc_name"
												value="<%=mybean.followupdesc_name%>" size="50"
												maxlength="255" />
											</div>
											...
											<center>
												...
												class="btn btn-success" id="add_button" value="Add Follow-up"
