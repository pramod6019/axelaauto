...
<jsp:useBean id="mybean" class="axela.sales.ManageLostCase1_Update"
	scope="request" />
<%
...
<body onLoad="FormFocus()" class="page-container-bg-solid page-header-menu-fixed">
				...
				<div class="page-content-inner">
					<div class="container-fluid">
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="managelostcase1-update.jsp?<%=mybean.QueryString%>"><%=mybean.status%>&nbsp;Lost Case 1</a><b>:</b></li>
						</ul>
									...
									<div class="tab-pane" id="">
										...
										<form name="form1" method="post" class="form-horizontal">
											...
											<div class="form-element6 form-element-center">
												...
												<input name="txt_lostcase1_name" type="text"
												class="form-control" id="txt_lostcase1_name"
												value="<%=mybean.lostcase1_name%>" size="50"
												maxlength="255" />
											</div>
											...
											<center>
												...
												<input name="addbutton" type="submit"
													class="btn btn-success" id="addbutton" value="Add Lost Case 1"
	...
	<script language="JavaScript" type="text/javascript">
		function FormFocus() { //v1.0
			document.form1.txt_lostcase1_name.focus()
		}
	</script>
</body>
</HTML>
