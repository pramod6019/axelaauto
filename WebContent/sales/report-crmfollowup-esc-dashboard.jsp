...
<jsp:useBean id="mybean" class="axela.sales.Report_CRMFollowup_Esc_Dashboard" scope="request"/>
			...
			<div class="page-head">
				<div class="container-fluid">
					...
					<div class="page-title">
						<h1>CRM Follow-up Escalation Dashboard</h1>
					</div>
					<!-- END PAGE TITLE -->
				</div>
			</div>
			 ...
			 <div class="page-content-inner">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="../sales/report-crmfollowup-esc-dashboard.jsp">CRM Follow-up Escalation Dashboard</a><b>:</b></li> 
					</ul>
						...
						<div class="tab-pane" id="">
							...
							<div class="portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none">CRM Follow-up Escalation Dashboard</div>
								</div>
											...
											<div class="form-element4">
												...
												<div id="multiprincipal">
													<select name="dr_principal" size="10" multiple="multiple" class="form-control multiselect-dropdown" id="dr_principal"
														onChange="PopulateCRMDays();PopulateBranches();PopulateModels();PopulateRegion();"><%=mybean.mischeck.PopulatePrincipal(mybean.brand_ids, mybean.comp_id, request)%>
													</select>
												</div>
											</div>
