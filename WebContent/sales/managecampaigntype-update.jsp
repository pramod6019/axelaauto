...
<jsp:useBean id="mybean" class="axela.sales.ManageCampaignType_Update"
	scope="request" />
<%
				...
				<div class="page-content-inner">
					<div class="container-fluid">
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="managecampaigntype.jsp?all=yes">List Campaign Type</a> &gt;</li>
							<li><a href="managecampaigntype-update.jsp?<%=mybean.QueryString%>"><%=mybean.status%> Campaign Type</a><b>:</b></li>
									...
									<div class="tab-pane" id="">
										...
										<form name="form1" method="post" class="form-horizontal">
											...
											<div class="form-element6 form-element-center">
												...
												<input name="txt_camptype_desc" type="text"
												class="form-control" id="txt_camptype_desc"
												value="<%=mybean.camptype_desc%>" size="50" maxlength="255" />
