...
<jsp:useBean id="mybean" class="axela.sales.Report_Followup_Esc_Dash"
	scope="request" />
			...
			<div class="page-head">
				<div class="container-fluid">
					...
					<div class="page-title">
						<h1>Follow-up Escalation Dashboard</h1>
					</div>
					<!-- END PAGE TITLE -->
				</div>
			</div>
				...
				<div class="page-content-inner">
					<div class="container-fluid">
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="../sales/report-followup-esc-dash.jsp">Follow-up Escalation Dashboard</a><b>:</b></li> 
						</ul>
									...
									<div class="tab-pane" id="">
										...
										<form method="post" name="frm1" id="frm1" class="form-horizontal">
													...
													<div>
														<span id="multiprincipal">
															<select name="dr_principal" size="10" multiple="multiple" class="form-control multiselect-dropdown" id="dr_principal"
																onChange="PopulateBranches();PopulateModels();PopulateRegion();"><%=mybean.mischeck.PopulatePrincipal(mybean.brand_ids, mybean.comp_id, request)%>
															</select>
														</span>
													</div>
												</div>
												...
												<div class="form-element4">
													...
													<div id="exeHint">
														<%=mybean.mischeck.PopulateSalesExecutives(mybean.team_id, mybean.emp_ids, mybean.comp_id, request)%>
													</div>
												</div>
