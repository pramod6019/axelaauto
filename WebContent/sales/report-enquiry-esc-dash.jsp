...
<jsp:useBean id="mybean" class="axela.sales.Report_Enquiry_Esc_Dash" scope="request"/>
			...
			<div class="page-head">
				<div class="container-fluid">
					...
					<div class="page-title">
						<h1>Enquiry Escalation Dashboard</h1>
					</div>
					<!-- END PAGE TITLE -->
				</div>
			</div>
			...
			<div class="page-content">
				...
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="../sales/report-enquiry-esc-dash.jsp">Enquiry Escalation Dashboard</a><b>:</b></li> 
					</ul>
						...
						<div class="tab-pane" id="">
							...
							<div class="portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none">Enquiry Escalation Dashboard</div>
								</div>
									...
									<div class="tab-pane" id="">
										...
										<form method="post" name="frm1" id="frm1" class="form-horizontal">
												...
												<div class="form-element4">
													<label>Teams:</label>
													<div id="teamHint">
														<%=mybean.mischeck.PopulateTeams(mybean.branch_id, mybean.enquiry_team_id, mybean.comp_id, request)%>
													</div>
												</div>
												...
												<div class="form-element4">
													...
													<div id="exeHint">
														<%=mybean.mischeck.PopulateSalesExecutives(mybean.team_id, mybean.enquiry_emp_id, mybean.comp_id, request)%>
													</div>
												</div>
