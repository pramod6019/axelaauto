...
<jsp:useBean id="mybean" class="axela.sales.Enquiry_User_Import_General"
	scope="request" />
<%
					...
					<div class="page-content-inner">
						<div class="container-fluid">
							...
							<form class="form-horizontal" name="frmdoc" id="frmdoc"
								...
								<div class="portlet box  ">
									...
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											...
											<center>
												<a href="../Library/template/enquiry-import-general.xlsx" target="_blank"><b>Click
								...
								<div class="portlet box  ">
									<div class="portlet-title" style="text-align: center">
										<div class="caption" style="float: none">Import General Enquiries
										</div>
									</div>
									<div class="portlet-body portlet-empty">
										<div class="tab-pane" id="">
											...
											<div align="center">
												<input name="addbutton" type="submit"
													...
													value="Upload" /> 
													<input name="add_button1" type="hidden"
													class="button" id="add_button" value="Upload" />
													<input name="add_button1" type="hidden" class="button"
