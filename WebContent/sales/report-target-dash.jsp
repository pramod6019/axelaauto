...
<jsp:useBean id="mybean" class="axela.sales.Report_Target_Dash" scope="request"/>
				...
				<div class="page-content-inner">
					<div class="container-fluid">
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="../sales/report-target-dash.jsp">Target Dashboard</a><b>:</b></li>
						</ul>
						...
						<div class="tab-pane" id="">
							<div class="portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none">Target Dashboard
									</div>
								</div>
									...
									<div class="tab-pane" id="">
										...
										<form method="post" name="frm1" id="frm1"
											...
											<div class="form-element6">
												...
												<div>
													<select name="dr_startmonth" class="form-control" id="dr_startmonth">
											...
											<div class="form-element6">
												...
												<div>
													<select name="dr_endmonth" class="form-control" id="dr_endmonth">
														<%=mybean.PopulateEndMonth()%>
													</select>
												</div>
											</div>
