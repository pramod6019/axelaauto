...
<jsp:useBean id="mybean" class="axela.sales.ManageTradeInModel_Update"
	scope="request" />
<%
...
<body onLoad="FormFocus()" class="page-container-bg-solid page-header-menu-fixed">
	...
	<div class="page-container">
				...
				<div class="page-content-inner">
					<div class="container-fluid">
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="../sales/managetradeinmodel.jsp?all=yes">List Models</a> &gt;</li>
							<li><a href="../sales/managetradeinmodel-update.jsp?<%=mybean.QueryString%>"><%=mybean.status%>&nbsp;Model</a><b>:</b></li> </ul>
										...
										<div class="tab-pane" id="">
											...
											<form name="form1" method="post" class="form-horizontal">
												...
												<div class="form-element6">
													...
													<input name="txt_tradeinmodel_name" type="text"
														class="form-control" id="txt_tradeinmodel_name"
														value="<%=mybean.tradeinmodel_name%>" size="50"
														maxlength="255" />

												</div>

												<div class="form-element6 ">
													<label> Make<font color=red>*</font>: </label>
													<select name="dr_tradeinmake_id"
													id="dr_tradeinmake_id" class="form-control">
													<%=mybean.PopulateMake()%>
													</select>
												</div>
												...
												<center>
													...
													class="btn btn-success" id="addbutton" value="Add Model"
		...
		<script language="JavaScript" type="text/javascript">
			function FormFocus() {
				document.form1.txt_tradeinmodel_name.focus();
			}
		</script>
</body>
</HTML>
