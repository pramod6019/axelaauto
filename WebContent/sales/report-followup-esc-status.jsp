...
<jsp:useBean id="mybean" class="axela.sales.Report_Followup_Esc_Status"
	scope="request" />
			...
			<div class="page-head">
				<div class="container-fluid">
					...
					<div class="page-title">
						<h1>Follow-up Escalation Status</h1>
					</div>
					<!-- END PAGE TITLE -->
				</div>
			</div>
				...
				<div class="page-content-inner">
					<div class="container-fluid">
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="../sales/report-followup-esc-status.jsp">Follow-up Escalation Status</a><b>:</b></li> 
						</ul>
						...
						<div class="tab-pane" id="">
							...
							<div class="portlet box">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none">Follow-up Escalation Status</div>
								</div>
