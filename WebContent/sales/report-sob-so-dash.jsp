...
<jsp:useBean id="mybean" class="axela.sales.Report_SOB_SO_Dash" scope="request"/>
...
<TABLE width="98%" border="0" align="center" cellPadding="0" cellSpacing="0">
  <TR>
    <TD align="left"><a href="../portal/home.jsp">Home</a> &gt; <a href="../portal/mis.jsp">MIS</a> &gt; <a href="report-sob-so-dash.jsp">Sales Order SOB Dashboard</a>:</TD>
  </TR>
        <tr>
              ...
              <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0"  class="tableborder">
                <tr>
                  <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="listtable" >
                      <tr>
                        <th colspan="7" align="center">Sales Order SOB Dashboard</th>
                      </tr>
                      <tr>
        ...
        <tr align="center">
          <td  align="center"><b>Closed Won  SOB Summary</b></td>
        </tr>
        <tr align="center">
        ...
        <tr align="center">
          <td  align="center"><b>Closed Lost SOB Summary</b></td>
        </tr>
        <tr align="center">
          <td height="200"  align="center" valign="top"><%=mybean.StrClosedHTML%></td>
        </tr>
        <tr align="center">
          <td  align="center">&nbsp;</td>
        </tr>
