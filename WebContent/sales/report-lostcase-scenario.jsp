...
<jsp:useBean id="mybean" class="axela.sales.Report_LostCase_Scenario" scope="request"/>
...
<%@include file="../portal/header.jsp" %>
			...
			<div class="page-content">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="report-lostcase-scenario.jsp">Lost Case Scenario</a><b>:</b></li>
					</ul>
						...
						<div class="tab-pane" id="">
							...
							<div class="portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none">Lost Case Scenario</div>
								</div>
								<div class="portlet-body portlet-empty container-fluid">
									<div class="tab-pane" id="">
										...
										<center>
											...
											<div class="form-element12" id="chart1" style="height: 1500px;"></div>
										...
										<center>
											<font color="red"><b></>Closed Lost SOE Summary</b></font>
										</center>

										<center>
											<%=mybean.StrClosedHTML%></td>
										</center>
										<center>
											<%=mybean.StrHTML%>
										</center>
	...
	<script language="JavaScript" type="text/javascript">
		...
		function PopulateBranches() { //v1.0
			...
			showHint('../sales/mis-check1.jsp?brand_id=' + brand_id + '&region_id=' + region_id + '&multiple=yes&branch=yes', 'branchHint');
		}
