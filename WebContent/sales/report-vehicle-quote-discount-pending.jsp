...
<jsp:useBean id="mybean" class="axela.sales.Report_Vehicle_Quote_Discount_Pending" scope="request"/>
			...
			<div class="page-content-inner">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="../sales/report-vehicle-quote-discount-pending.jsp">Quote Discount Pending</a><b>:</b></li> 
					</ul>
						...
						<div class="tab-pane" id="">
							...
							<div class="portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none">Quote Discount Pending
									</div>
								</div>
...
<!-- 											<div class="form-element11 form-element"> -->
							...
							%>
							<center><font color="red"><b>No Result Found!</b></font></center>
							<%
								}
							%>
						</div>
