...
<jsp:useBean id="mybean" class="axela.sales.Report_Campaign_Dash" scope="request"/>
			...
			<div class="page-content">
				...
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="../sales/report-campaign-dash.jsp">Campaign Dashboard</a><b>:</b></li>
					</ul>
						...
						<div class="tab-pane" id="">
							...
							<div class="portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none">Campaign Dashboard
									</div>
								</div>
