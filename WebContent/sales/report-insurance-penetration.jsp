...
<jsp:useBean id="mybean" class="axela.sales.Report_Insurance_Penetration" scope="request" />
			...
			<div class="page-content-inner">
				<div class="container-fluid">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="../sales/report-insurance-penetration.jsp">Insurance Penetration</a><b>:</b></li> 
					</ul>
						...
						<div class="tab-pane" id="">
							...
							<div class="portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none">Insurance Penetration </div>
								</div>
