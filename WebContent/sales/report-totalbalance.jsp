...
<jsp:useBean id="mybean" class="axela.sales.Report_TotalBalance" scope="request"/>
				...
				<div class="page-content-inner">
					<div class="container-fluid">
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="../sales/report-totalbalance.jsp">Total Balance Dues</a><b>:</b></li>
						</ul>
