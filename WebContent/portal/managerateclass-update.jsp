...
<jsp:useBean id="mybean" class="axela.portal.ManageRateClass_Update"
	scope="request" />
<%
				...
				<div class="page-content-inner">
					<div class="container-fluid">
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="managerateclass.jsp?all=yes">List Rate Classes</a> &gt;</li>
							<li><a href="managerateclass-update.jsp?<%=mybean.QueryString%>"><%=mybean.status%>&nbsp;Rate
									Class</a>:</li>
						</ul>
										...
										<form method="post" name="form1" class="form-horizontal">
											...
											<div class="form-element6">
												...
												<select name="dr_rateclass_type" class="form-control"
													id="dr_rateclass_type" style="width: 200px">
