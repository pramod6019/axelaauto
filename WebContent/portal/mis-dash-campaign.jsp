...
<jsp:useBean id="mybean" class="axela.portal.MIS_Dash_Campaign"
	scope="request" />
<%
			...
			<div class="page-content">
				<div class="container-fluid">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="mis-dash-campaign.jsp">Campaign Dashboard</a>:</li>
					</ul>
					...
					<div class="page-content-inner">
						<div class="tab-pane" id="">
							...
							<div class="container-fluid portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none">Campaign Summary</div>
								</div>
								<div class="portlet-body">
									<div class="tab-pane" id="">
										<%=mybean.StrHTML%>
