...
<jsp:useBean id="mybean" class="axela.portal.Executives" scope="request" />
<%
						...
						<div class="tab-pane" id="">
							...
							<div class="portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none">Executive Status
									</div>
								</div>
									...
									<div class="tab-pane" id="">
										...
										<form class="form-horizontal" name="form1" id="form1" method="post">
														...
														<label> Brands:</label>
															<div>
																<select name="dr_principal" size="10" multiple="multiple" class="form-control multiselect-dropdown" id="dr_principal"
																	onChange="PopulateBranches();PopulateRegion();document.form1.submit();">
													...
													<div class="form-element3">
														<label> Type:</label>
														<div></div>
														<select name="dr_type" size="10" multiple="multiple" class="form-control multiselect-dropdown" id="dr_type"
															onChange="PopulateBranches();document.form1.submit();">
															<%=mybean.execheck.PopulateBranchType( mybean.type_ids, mybean.comp_id, request)%>
														</select>
													</div>
													<div class="form-element3">
