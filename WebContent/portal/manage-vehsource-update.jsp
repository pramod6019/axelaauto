...
<jsp:useBean id="mybean" class="axela.service.Manage_VehSource_Update"
	scope="request" />
<%
			...
			<div class="page-head">
				<div class="container-fluid">
					...
					<div class="page-title">
						<h1><%=mybean.status%>&nbsp;Vehicle Source
						</h1>
					</div>
					<!-- END PAGE TITLE -->
			...
			<div class="page-content">
				<div class="container-fluid">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="manage-vehsource-list.jsp?all=yes">List
								Vehicle Source</a> &gt;</li>
						<li><a
							href="manage-vehsource-update.jsp?<%=mybean.QueryString%>"><%=mybean.status%>&nbsp;Vehicle
								Source</a>>:</li>
					</ul>
						...
						<div class="tab-pane" id="">
							...
							<div class="container-fluid portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none"><%=mybean.status%>&nbsp;Vehicle
										Source
									</div>
								</div>
									...
									<div class="tab-pane" id="">
										...
										<form method="post" name="form1" class="form-horizontal">
											<div class="form-group">
												<label class="control-label col-md-4">Vehicle Source
													<font color="#ff0000">*</font>:
												</label>
												<div class="col-md-6 col-xs-12">
													<input name="txt_vehsource_name" type="text"
														class="form-control" id="txt_vehsource_name"
														value="<%=mybean.vehsource_name%>" size="50"
														maxlength="255" />
												</div>
											</div>
											...
											<div class="form-group">
												<center>
													...
													<input name="button" type="submit" class="btn btn-success"
														id="button" value="Add Vehicle Source"
