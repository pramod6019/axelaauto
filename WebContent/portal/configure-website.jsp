...
<jsp:useBean id="mybean" class="axela.portal.Configure_Website" scope="request"/>
...
<script language="JavaScript" type="text/javascript">
    ...
    <body  onLoad="FormFocus()" leftmargin="0" rightmargin="0" topmargin="0" bottommargin="0"><%@include file="header.jsp" %>
        <TABLE width="98%" border="0" align="center" cellPadding="0" cellSpacing="0">
            <TR>
                <TD align="left"><a href="home.jsp">Home</a> &gt; <a href="manager.jsp#website">Business Manager</a> &gt; <a href="manager.jsp#website">Website</a> &gt; <a href="configure-website.jsp">Configure Website</a>: </TD>
            </TR>
             <tr><td>&nbsp;</td></tr>
            <TR>
                ...
                <TD height="300" align="center" vAlign="top">
                            ...
                            <tr>
                                <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listtable">
                                                    <tbody>
                                                        <tr align="center">
                                                            <th colspan="2">Configure Website</th>
                                                        </tr>
                                                        <tr>
                                                            <td width="30%">&nbsp;</td>
