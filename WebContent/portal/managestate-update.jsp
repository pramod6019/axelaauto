...
<jsp:useBean id="mybean" class="axela.portal.ManageState_Update"
	scope="request" />
<%
...
<body onload=FormFocus()
			...
			<div class="page-content-inner">
				<div class="container-fluid">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="managestate.jsp?all=yes">List States</a> &gt;</li>
						<li><a href="managestate-update.jsp?<%=mybean.QueryString%>"><%=mybean.status%>&nbsp;State</a><b>:</b></li>
					</ul>
									...
									<div class="tab-pane" id="">
										...
										<form method="post" name="form1" class="form-horizontal">
											...
											<div class="form-element6 form-element-center">
												...
												<input name="txt_state_name" id="txt_state_name"
													type="text" class="form-control"
													value="<%=mybean.state_name%>" size="50" maxlength="255" />
											</div>
											...
											<div class="row"></div> 
												...
												<center>
													...
													<input name="button" type="submit" class="btn btn-success"
														id="button" value="Add State"
														onClick="return SubmitFormOnce(document.form1, this);" />
													<input type="hidden" name="add_button" value="yes">
													<% } else if (mybean.status.equals("Update")) { %>
													<input type="hidden" name="update_button" value="yes">
													<input name="button" type="submit"
														class="btn btn-success" id="button" value="Update State"
														onClick="return SubmitFormOnce(document.form1, this);" />
													<input name="delete_button" type="submit"
														class="btn btn-success" id="delete_button"
														OnClick="return confirmdelete(this)" value="Delete State" />
													<% } %>
												</center>
	...
	function FormFocus() {
		document.form1.txt_state_name.focus()
	}
</script>	
</html>