<%@ page errorPage="../adminpanel/error-page.jsp"%>
<jsp:useBean id="mybean" class="axela.portal.ManageAccess_Update"
	scope="request" />
<%
			...
			<div class="page-content-inner">
				<div class="container-fluid">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="manageaccess.jsp"> Manage Access</a> &gt;</li>
						<li><a href="manageaccess-update.jsp?<%=mybean.QueryString%>"><%=mybean.status%>&nbsp;Access</a>:</li>
					</ul>
					<!-- END PAGE BREADCRUMBS -->
							...
							<div class="container-fluid portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none"><%=mybean.status%>&nbsp;Access
									</div>
								</div>
										...
										<form method="post" name="form1" class="form-horizontal">
											<div class="form-element6 form-element-center">
												<label>Module <font color="#ff0000">*</font>: </label>
													<select name="dr_module" id="dr_module"
														class="form-control">
											...
											<div class="form-element6 form-element-center">
												<label>Access<font color="#ff0000">*</font>: </label>
													<input name="txt_access_name" id="txt_access_name"
														type="text" class="form-control"
														value="<%=mybean.access_name%>" size="50" maxlength="255" />
											</div>
											<%
											...
											<div class="row"></div>
												<center>
													...
													<input name="update_button" type="submit"
														class="btn btn-success" id="button" value="Update Access"
														onClick="return SubmitFormOnce(document.form1, this);" />
													<input name="delete_button" type="submit"
														class="btn btn-success" id="delete_button"
														onClick="return confirmdelete(this)" value="Delete Access" />
													<%
														}
													%>
												</center>
