...
<jsp:useBean id="mybean" class="axela.portal.Managefranchtype_Update"
	scope="request" />
<%
...
<body onLoad="FormFocus()" class="page-container-bg-solid page-header-menu-fixed">
			...
			<div class="page-head">
				<div class="container-fluid">
					...
					<div class="page-title">
						<h1><%=mybean.status%>&nbsp;Franchisee Type
						</h1>
					</div>
					<!-- END PAGE TITLE -->
				...
				<div class="page-content-inner">
					<div class="container-fluid">
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="managefranchtype.jsp?all=yes">List Franchisee Types</a> &gt;</li>
							<li><a href="managefranchtype-update.jsp?<%=mybean.QueryString%>"><%=mybean.status%>&nbsp;Franchisee
									Type</a>:</li>
						...
						<div class="tab-pane" id="">
							...
							<div class="container-fluid portlet box">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none"><%=mybean.status%>&nbsp;Franchisee
										Type
									</div>
								</div>
									...
									<div class="container-fluid">
										...
										<form method="post" name="form1" class="form-horizontal">
											...
											<div class="form-element6 form-element-center">
												<label>Franchisee Type<font color="#ff0000">*</font>: </label>
												<input name="txt_franchiseetype_name"
													id="txt_franchiseetype_name" class="form-control"
													value="<%=mybean.franchiseetype_name%>" maxlength="255" />
											</div>
	...
	function FormFocus() { //v1.0
		document.form1.txt_franchiseetype_name.focus()
	}
</script>
