...
<jsp:useBean id="mybean" class="axela.portal.Region_Update"
	scope="request" />
<%
...
<body onLoad="FormFocus()" class="page-container-bg-solid page-header-menu-fixed">
				...
				<div class="page-content-inner">
					<div class="container-fluid">
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="region-list.jsp?all=yes">List Regions</a> &gt;</li>
							<li><a href="region-update.jsp?<%=mybean.QueryString%>"><%=mybean.status%>&nbsp;Region</a>:</li>
						</ul>
						...
						<div class="tab-pane" id="">
							...
							<div class="container-fluid portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none"><%=mybean.status%>&nbsp;Region
									</div>
								</div>
										...
										<form method="post" name="form1" class="form-horizontal">
											...
											<div class="form-element6 form-element-center">
												...
												<input class="form-control" type="text"
													name="txt_region_name" id="txt_region_name"
													value="<%=mybean.region_name%>" size="50" maxlength="255">
											</div>
											...
											<div class="form-element6 form-element-center">
												<div class="form-element6 form-element">
													...
													<input class="form-control" type="hidden" name="entry_by" id="entry_by"
												...
												<div class="form-element6">
													...
													<%=mybean.entry_date%>
													<input class="form-control" type="hidden" name="entry_date"
														id="entry_date" value="<%=mybean.entry_date%>">
												</div>
											</div>
											...
											<div class="form-element6 form-element-center">
												<div class="form-element6 form-element">
													...
													<input class="form-control" type="hidden"
														name="modified_by" id="modified_by"
											...
											<div class="form-element6 form-element-center">
												<center>
													...
													<input name="button" type="submit" class="btn btn-success"
														id="button" value="Add Region"
														onClick="return SubmitFormOnce(document.form1, this);" />
													<input type="hidden" name="add_button" value="yes">
													<% } else if (mybean.status.equals("Update")) { %>
													<input type="hidden" name="update_button" value="yes">
													<input name="button" type="submit" class="btn btn-success"
														id="button" value="Update Region"
														onClick="return SubmitFormOnce(document.form1, this);" />
													<input name="delete_button" type="submit"
														class="btn btn-success" id="delete_button"
														OnClick="return confirmdelete(this)" value="Delete Region" />
													<%	} %>
	...
	<script language="JavaScript" type="text/javascript">
		function FormFocus() { //v1.0
			document.form1.txt_region_name.focus()
		}
	</script>
</body>
</html>
