...
<jsp:useBean id="mybean" class="axela.portal.Exe_Update" scope="request" />
...
<body onLoad="FormFocus();DisplayBranch();DisplayBranch1();Displayemp();"
...
<!-- 											</div> -->
											...
											<div class="form-element6">
												<label> Landmark: </label>
													...
													<br /> <span id="span_txt_emp_landmark">(255
														Characters)</span>
											</div>
											...
											<div class="form-group">
												<div id="emprows3">
													...
													<div class="form-element2">
														<center>
															<br /> <br /> <br /> <br /> <br /> <input
																...
																value="   Add &gt;&gt;" /> <br /><br> <input name="Input3"
													...
													<div class="form-element5">
														...
														multiple="multiple" class="form-control temp"
															id="exe_branch_trans">
										...
										<div class="tab-pane" id="">
											...
											<center>
												<label> All Executives: </label> &nbsp;&nbsp;<input
													name="chk_emp_all_exe" type="checkbox" id="chk_emp_all_exe" size="15"
...
<!-- 												                        </tr> -->
													...
													<input name="ch_emp_stock_ageing" type="checkbox"
														id="ch_emp_stock_ageing"
											...
											<div id="mobile_view">
															...
															<div class="form-element6">
																...
																<input name="txt_emp_clicktocall_campaign" type="text"
															...
															<div class="form-element6">
																...
																<input name="txt_emp_ip_access"
																	...
																	maxlength="255" />
																	<span>(comma and space
																	seperated for each IP Address) <br /> Eg.:
																	192.168.0.1, 192.168.1.6</span>
									...
									<div class="portlet-body portlet-empty container-fluid">
										<div class="tab-pane" id="">
											...
											<div class="form-group">
												<div id="emprows">
													...
													<div class="form-element2"><center>
														<br /> <br /> <br /> <br /> <br /> <input
										...
										<center>
											...
											<input type="hidden" name="update_button" value="yes" /> <input
												name="" type="submit" class="btn btn-success"
												id=""
												onClick="onPress(); return SubmitFormOnce(document.formemp, this);"
