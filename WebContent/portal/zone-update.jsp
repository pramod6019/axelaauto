...
<jsp:useBean id="mybean" class="axela.portal.Zone_Update"
	scope="request" />
<%
...
<body onLoad="FormFocus()" class="page-container-bg-solid page-header-menu-fixed">
				...
				<div class="page-content-inner">
					<div class="container-fluid">
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="zone-list.jsp?all=yes">List Zones</a> &gt;</li>
							<li><a href="zone-update.jsp?<%=mybean.QueryString%>"><%=mybean.status%>&nbsp;Zone</a><b>:</b></li>
						</ul>
						<!-- END PAGE BREADCRUMBS -->
							...
							<div class="container-fluid portlet box  ">
								<div class="portlet-title" style="text-align: center">
									<div class="caption" style="float: none"><%=mybean.status%>&nbsp;Zones
									</div>
								</div>
										...
										<form method="post" name="form1" class="form-horizontal">
											...
											<div class="form-element6 form-element-center">
												...
												<input class="form-control" type="text"
													name="txt_zone_name" id="txt_zone_name"
													value="<%=mybean.zone_name%>" size="50" maxlength="255">
											</div>
	...
	<script language="JavaScript" type="text/javascript">
		function FormFocus() { //v1.0
			document.form1.txt_zone_name.focus()
		}
	</script>
</body>
</html>
